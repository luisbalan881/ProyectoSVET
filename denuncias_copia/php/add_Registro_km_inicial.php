...
//insertar a tabla
$sql = "INSERT INTO  tb_proyecto (nombre, descripcion, fecha_inicio,fecha_fin ,status,dep_id) VALUES (?,?,?,?,?,?)";

//INSERT INTO  tb_proyecto (nombre, descripcion) VALUES ("a1", "jf")

$q = $pdo->prepare($sql);
$q->execute(array($nombre,$motivo,$date1,$date2,$status,$departamneto));
$Id = $pdo->lastInsertId();
Database::disconnect();
echo $Id;
