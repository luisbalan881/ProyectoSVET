                                    ...
                                    <div class="col-xs-4">
                                        <div class="">
                                            <input class="form-control"  type="file" id="arch_original" name="arch_original"
                                                   ...
                                                   image/jpeg,
                                                   image/png" >
                                            <label for="arch_original">Ingrese documento*</label>
                                        </div>
                                    </div>
              ...
              <div class="block-content">
                      ...
                      <table class="table table-bordered table-condensed table-striped js-dataTable-proyectos dt-responsive display nowrap" cellspacing="0" width="100%">  
                          ...
                          <tr>
                              ...
                              <th class="text-center">fecha y hora de creación de actividad </th>
                              
                              
                              <th class="text-center">A cargo de</th>
                              <th class="text-center">Material</th>
                              <th class="text-center">participacion de Secretaria ejecutiva</th>
                              <th class="text-center"> Agenda</th>
                              <th class="text-center">cambira estado de actividad: </th>
                          ...
                          //  echo '<td class="text-left" style="white-space: nowrap;">'.fecha_dmy($actividad['fecha_creacion']).'</td>'; //fecha de creación
                            ...
                            {
                             echo '<span>Solo el usuario que creo la actividad puede rlizar esta acción</span>';
                            ...
                            else if($actividad['status']==1)
                            {
                             ...
                             // echo '<span class="label label-success">Aprobado</span> </td>';
                              echo '  <div class="progress">
                                                                ...
                                                                <div class="progress-bar progress-bar-success progress-bar-striped active" role="progressbar" style="width:66.66%;"></div>
                                                                66.66% completado 
                                                             </div>';
                            }
                            else if($actividad['status']==3){
