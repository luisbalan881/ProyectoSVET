        ...
        <body>
          <div class="">
            ...
            <div class="block-content ">
              <form id="SolicitudForm" class="js-validation-solicitud form-horizontal form-style-10" action="denuncias/nueva_denuncia.php" method="POST" enctype="multipart/form-data">
                <h1>Denuncias anonimas SVET<span>Formulario para la creación de denuncia anonima</span></h1>
                  <div class="form-group">
                      <div class="col-xs-12">
                          <div class="form-material">
                              <!--<input class="js-tags-input form-control" type="text" id="destinatarios" name="destinatarios" value="" required>-->

                              <label for="destinatarios">Tipo de denuncia*</label>
				   ...
				   <div class="form-group">
                      <div class="col-xs-12">
                          <div class="form-material">
                              ...
                              <label for="destinatarios">Quien cometio la falta*</label>
                              <div class="input-group has-personalizado">
                                <span class="input-group-addon" ><span class="fa fa-bank"></span></span>
                  ...
                  <div class="form-group">
				   ...
				   <div class="form-group">
                    <div class="col-xs-12">
                          ...
                          <div class="has-personalizado">
                            <label for="soli_desc">Archivo</label>
                            <div class="input-group has-personalizado">
                              <span class="input-group-addon" ><span class="si si-pencil"></span></span>
                 ...
                 <div class="form-group">
                                    <div class="col-xs-12 text-center">
                                        <button class="btn btn-sm btn-primary btn-block" type="submit"><i class=""></i>Agregar Denuncia</button>
                                    </div>
                                </div>
                </form>
