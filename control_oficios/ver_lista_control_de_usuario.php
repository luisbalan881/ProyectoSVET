             ...
             <table class="table table-bordered table-condensed table-striped js-dataTable-directorio" >
                 <thead>
                     <tr>
                         ...
                         <th class="hidden-xs text-center">Plazo de Respuesta </th>
                         <th class="hidden-xs text-center">Descripción</th>
                         <th class="hidden-xs text-center">Dirigido A:</th>
                       
                         <th class="text-center">Documento enviado</th>
                     ...
                     <?php
                       ...
                       foreach ($nombramientos as $nombramiento){
                         //foreach ($personas as $persona){
                           // if($persona['ext_id'] > 0 && $nombramiento['user_estatus'] == 1){
                                echo '<tr>';
                              ...
                              //  echo '<td class="hidden-xs">'. $id2.'</td>';
                             ...
                             echo '<span style="white-space: nowrap;"><strong>doc. Recibido: </strong><a target="_blank" href="control_oficios/'.$nombramiento['url_oficio'].'"><button class="btn btn-xs btn-default outline" type="button" data-toggle="tooltip" title="Ver Documento  "><i class="fa fa-file"></i> Ver </button></a></span> <br>';// acción
                             ...
                             {
                               echo '<span style="white-space: nowrap;"><strong>sin doc. cargado </strong></span> <br>';// acción
                            

                               } else{
                             echo '<span style="white-space: nowrap;"><strong>doc. Respuesta: </strong><a target="_blank" href="control_oficios/'.$nombramiento['url_oficio_respuesta'].'"><button class="btn btn-xs btn-default outline" type="button" data-toggle="tooltip" title="Ver archivo"><i class="fa fa-file"></i> Ver </button></a></span> <br>';// acción
                             // echo '<span data-toggle="tooltip" title="Dar Seguimiento"><a class="btn btn-default"  title="Dar Seguimiento"  data-toggle="modal" data-target="#modal-remoto-lgg" href="compras/solicitar_aprobacion.php?id='.$s['id_solicitud_compra'].'"><i class="fa fa-pencil-square-o text-warnig"></i></a></span>';
                             ...
                             echo '</td>';  
                                 ...
                                 echo '<div class="btn-group">';
                                    ...
                                    if ($nombramiento['estatus'] == 6)
                                {
                                 echo '<span data-toggle="tooltip" title="Liquidar con amplicacion"><a class="btn btn-default"  title=" liquidación"  data-toggle="modal" data-target="#modal-remoto" href="viaticos/liquidarConAmpliacion.php?id='.$nombramiento['id'].'"><i class="fa fa-pencil text-warning"></i></a></span>';
                                  }
									  ...
									  if ($nombramiento['estatus'] ==4)
                                {
								 ...
								 // code para anular
                                   /*if ($nombramiento['estatus'] == 1 )
                                {
                                 echo '<span data-toggle="tooltip" title="Anular"><a class="btn btn-default"  title="Anular"  data-toggle="modal" data-target="#modal-remoto" href="viaticos/solicitar_anulacion.php?id='.$nombramiento['id'].'"><i class="fa fa-times text-danger"></i></a></span>';
                                  }
                                  
                                if ($nombramiento['estatus'] == 0 ){
                                    echo '<span class="label label-warning"> Anulada</span> </td>';
                                    //echo'-liquidado';
                                }  */
                                  
                                else if ($nombramiento['estatus'] == 1 ){
                                    //echo '<span class="label label-primary">Solicitud Enviada</span> </td>';
                                     echo '<span class="label label-primary">Nuevo Oficios Recibido <a class="btn btn-default"  title="Dar Seguimiento"  data-toggle="modal" data-target="#modal-remoto-lgg1" href="control_oficios/crear_ingreso2.php?id='.$nombramiento['id'].'"><i class="fa fa-pencil text-secundary"></i></a></span> </td>';
                                }
								 else if ($nombramiento['estatus'] == -1 ){
                                   echo '<span class="label label-info">Asignación de Actividad generado <a class="btn btn-default"  title="Editar Nombramiento"  data-toggle="modal" data-target="#modal-remoto-lgg1" href="viaticos/solicitar_nombramiento_editable.php?id='.$nombramiento['id'].'"><i class="fa fa-pencil text-warning"></i></a> </span> </td>';
                                    ...
                                    echo '<span class="label label-primary"> Respuesta enviada</span> </td>';
                                    //echo'-liquidado';
                                }
