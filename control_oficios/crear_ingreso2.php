        ...
        <body>
          <div class="">
            ...
            <div class="block-content ">
              <form id="SolicitudForm" class="js-validation-solicitud form-horizontal form-style-10" action="control_oficios/nuevo_seguimiento2.php" method="POST" enctype="multipart/form-data">
                <h1>Control de oficios SVET<span>Formulario para Respuetsa de control de oficios</span></h1>
                <!--   <div class="form-group">
                    ...
                    <div class="col-xs-12">
                          ...
                          <div class="has-personalizado">
                            <label for="objetivo">obs/desc. (Campo obligatorio)</label>
                            <div class="input-group has-personalizado">
