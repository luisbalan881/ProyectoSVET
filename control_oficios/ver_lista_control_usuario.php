                       ...
                       foreach ($nombramientos as $nombramiento){
                         //foreach ($personas as $persona){
                           // if($persona['ext_id'] > 0 && $nombramiento['user_estatus'] == 1){
                             ...
                             echo '<span style="white-space: nowrap;"><strong>doc: </strong><a target="_blank" href="control_oficios/'.$nombramiento['url_oficio'].'"><button class="btn btn-xs btn-default outline" type="button" data-toggle="tooltip" title="Ver Documento  "><i class="fa fa-file"></i> Ver </button></a></span> <br>';// acción
