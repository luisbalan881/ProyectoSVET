...
$vehiculos = get_carros();
  ...
  echo '    <thead >
          ...
          <th class="text-center">TIPO</th>
              ...
              echo '  <span id="" title="Bloquear fecha de solicitud de vehículo" class="btn-add" type="button" data-toggle="modal" data-target="#modal-remoto-lgg" href="transporte/boloqueo_fecha_solicitar_transporte.php" style="margin-top:-18px;margin-right:-18px;" ></span>';
