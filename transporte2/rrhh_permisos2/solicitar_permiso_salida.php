<?php
    ...
    if (function_exists('login_check') && login_check() == true) :
        ...
        <head>
            ...
            <title>Solicitar Pase de salida</title>
            ...
            <script src="assets/js/pages/solicitud_form_validate_permiso_salida3.js"></script>
          ...
          <div class="">
            ...
            <div class="block-content ">
              ...
              <form id="SolicitudForm" class="js-validation-solicitud form-horizontal form-style-10" method="POST" enctype="multipart/form-data">
                <h1>Solicitar Permiso<span>Formulario de solicitud de Permiso o Licencia  </span></h1>
				 ...
				 <div class="col-xs-2 col-sm-25">
                      ...
                      <div class="col-xs-2 col-sm-25">
                          ...
                          <div class="form-material">
                            <div class="input-group has-personalizado">
                              <span class="input-group-addon" ><span class="fa fa-calendar-check-o"></span></span>
                              <select class="form-control" name="opcion1" id="opcion1"data-placeholder="Seleccione" required>
                                <option value="" disabled selected hidden>Selecionar una opcion</option>
                                <option value="1"> Si</option>
                                <option value="2"> No</option>
                              </select>
                            </div>
                            <label for="destinatarios">Ausentarse el día completo:</label>
                          </div>
                      </div>
					  </div>
                  ...
                  <div class="form-group">
                    <div class="col-xs-12">
                          ...
                          <div class="has-personalizado">
                            ...
                            <div class="input-group has-personalizado">
                              ...
                              <textarea class="form-control" id="soli_motivo" name="soli_motivo" maxlength="90" rows="1"  required  ></textarea>
                            </div>
                    ...
                    <div class="col-xs-12">
                          ...
                          <div class="has-personalizado">
                            ...
                            <div class="input-group has-personalizado">
                              <span class="input-group-addon" ><span class="si si-pencil"></span></span>
                              <textarea class="form-control" id="soli_obs" name="soli_obs" maxlength="90" rows="1"  required  ></textarea>
                            </div>
                  ...
                  <div class="form-group">
                    <div class="col-sm-12 text-center">
                        <button id="boton_s_t" class="btn btn-sm btn-primary btn-block" onclick="add_solicitudN(<?php echo $id ?>,<?php echo $persona->persona['dep_id']?>)" ><i id="loading1" class="fa fa-refresh fa-spin" style="display:none;"></i> Crear Solicitud</button>
                    </div>
                  </div>
