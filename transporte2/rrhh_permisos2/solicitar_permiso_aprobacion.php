<?php
    ...
    if (function_exists('login_check') && login_check() == true) :
        if ($u->hasPrivilege('crearSolicitudTransporte') ) :
		  ...
		  $solicitud_permiso = permiso_salida_admin0($id2);
        ...
        <head>
            ...
            <script src="assets/js/pages/solicitud_form_validate_solicitud_permiso.js"></script>
          ...
          <div class="">
            ...
            <div class="block-content ">
              <form id="SolicitudForm" class="js-validation-solicitud form-horizontal form-style-10" method="POST" enctype="multipart/form-data">
                <h1>Aprobar Solicitud <span> ¿Esta realmente seguro(a) de autorizar esta solicitud?</span></h1>
                 ...
                 <div class="col-xs-12 col-sm-35">
					  ...
					  <div class="col-xs-12 col-sm-35">
                          ...
                          <div class="form-material ">
                            <div class="input-group has-personalizado">
                              <span class="input-group-addon" ><span class="fa fa-clock-o"></span></span>
                              <input class="form-control"  type="number"  id="soli_tiempo2" name="soli_tiempo2" value="<?php echo $solicitud_permiso['año']; ?>" disabled >
                            </div>
                            <label for="soli_tiempo">No. Solicitud *</label>
                          </div>
                      </div> 
                  ...
                  <div class="form-group">
                    <div class="col-sm-12 text-center">  
                        <button id="boton_s_t" class="btn btn-sm btn-success btn-block" onclick="add_formulario(<?php echo $id ?>,<?php echo $persona->persona['dep_id']?>, <?php   echo $id2 ?>)" ><i id="loading1" class="fa fa-refresh fa-spin" style="display:none;"></i> Aceptar Solicitud</button>
                    </div>
                  </div>
