  ...
  dataType:'json',
	...
	var doc = new jsPDF();
	   ...
	   //doc.text(33, 50, 'BOLETA DE SOLICITUD Y AUTORIZACIÓN DE VEH�?CULO PARA COMISIONES');
		 ...
		 doc.setFontSize(11);
		 doc.writeText(0, 35 ,'INFORME DE COMISIÓN',{align:'center',width:195});
		...
		// doc.text(55, 72, p_lineas1);
		 ...
		 doc.text(15, 66, 'Por este medio hago de su conocimiento que según nombramiento');
                  doc.writeText(121, 66 ,''+data.correlativo);
		 doc.text(15, 70, 'de fecha ');
                  doc.text(30, 70, data.fecha1);
                 doc.text(50, 70, 'fui nombrado (a) para realizar la siguiente comisión:                    ');
		 ...
		 doc.setTextColor(68, 68, 68);
                ...
                doc.text(15, 90, 'Objetivos de la Comision:');
		 ...
		 doc.setTextColor(68, 68, 68);
                ...
                doc.text(15, 194, 'Logros:');
                //doc.text(54, 114, data.obj2);
                 doc.setFontType("normal");
		 doc.setTextColor(68, 68, 68);
                  var p_lineas8 = doc.splitTextToSize(data.log, 185);

		 doc.text(15, 198, p_lineas8);
