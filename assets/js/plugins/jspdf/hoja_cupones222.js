function datos_hoja_cupones22(year,mes,solicitud_id,dep_id){
  ...
  $.ajax({
    ...
    beforeSend:function(){
          ...
          success:function(data){
            ...
            doc.setFontSize(10);
            doc.writeText(0, 25 ,data.data[i].solicitud,{align:'right',width:190});
            ...
            doc.setFontSize(10);
            doc.writeText(0, 18 ,'DE AUTORIZACION DE ENTREGA DE COMBUSTIBLE',{align:'center',width:215});
