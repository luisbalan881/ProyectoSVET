...
//destino
	...
	var doc = new jsPDF();
        ...
        //logo1.src = 'assets/img/solicitudcomprabackup.jpeg'; // img sin fondosolicitudcomprabackup
...
//  correlativos 
		 ...
		 doc.setTextColor(68, 68, 68);
                 doc.setFontSize("8");
                  doc.text(204, 25,  data.correlativo);  //id correlativo de contraloria
		 ...
		 doc.setTextColor(68, 68, 68);
                 doc.setFontSize("8");
                  doc.text(204, 25,  data.correlativo);  //id de borrador

                           }

  		 else {
  			doc.text(204, 25,"REF");  //id_soli
                        doc.text(208, 25,  data.id_soli);  //id 
...
/*
 ...
 if(data.correlativo <= 1000){
		 ...
		 doc.setTextColor(68, 68, 68);
           ...
           doc.writeText(20, 200 ,'Forma autorizada según Resolución de la contraloría General de Cuentas Numero F.0.-JM-119-2023/002235 GESTION: 829024 DEL 15-05-2023; número correlativo y fecha de autorización de impresión 642-2023 DE ');


           doc.writeText(20, 202 ,'FECHA 17/08/2023; número y fecha del tipo de envió fiscal E. FISCAL 4-ASCC 21040 DE FECHA 17-08-2023; Rango de numeración impresa del 001 al 2,000. Secretaría contra la Violencia Sexual Explotación y Trata de ');

doc.writeText(60, 204 ,'Personas, NIT 7463923-4, Libro 4-ASCC Folio 111, cuentadancia S1-38');

doc.writeText(70, 206 ,'Original: Expediente de Pago; Duplicado: Area de Compras');


                      
                           }
		
		else if(data.correlativo <= 2000){

                    doc.writeText(35, 47 ,'xxxxxxxxxxxxxxxxxxxx');
                    ...
                    doc.writeText(15, 260 ,'SECR999999.');
...
/*
var p_lineasfecha = doc.splitTextToSize(data.fecha, 12);//58
   doc.text(59, 42, p_lineasfecha); */
