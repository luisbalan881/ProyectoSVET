  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      for (var i = 0; i < data.data.length; i++) {
        ...
        doc.setFontSize(10);
        doc.writeText(0, 50, data.data[i].solicitud, {
          align: 'right',
          width: 190,
        });
        ...
        /*DATOS DEL CARRO*/
        doc.setFontType('bold');
        doc.text(125, 69, 'Fecha de Registro');
        ...
        doc.setTextColor(68, 68, 68);
        doc.setFontType('bold');
        doc.writeText(0, p2, 'Total autorizado : Q   ' + total + '.00', {
          align: 'right',
          width: 180,
        });
        ...
        doc.writeText(
          0,
          240,
          'Elaborado_________________________                         Vo. Bo _________________________',
        ...
        doc.writeText(
          0,
          258,
          'Nombre y Firma de quien recibe los cupones___________________________________________',
          { align: 'center', width: 215 },
        );
        ...
        //doc.writeText(0, 258 ,'Reporte Generado vicesis - M�dulo control de cupones',{align:'center',width:215});
