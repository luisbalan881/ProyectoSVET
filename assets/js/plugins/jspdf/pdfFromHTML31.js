...
//destino
		...
		// doc.text(55, 92, p_lineas1);
		 doc.text(40, 147, data.autorizado2);
                 doc.text(40, 157, data.puesto);
				  doc.text(151, 157, data.sueldo); //sueldo
				  doc.text(85, 165, data.partida);
 ...
 var c1=data.id1;
		...
		doc.text(17, 256, 'Forma autorizada según Resolución  de la Contraloría General de Cuentas No. MP./002738 número de Gestión 390881 de fecha 09-08-2019');
		doc.text(17, 259, 'correlativo 781-2019 de fecha 26-08-2019 Enváo Fiscal 4-ASCC 16758 de fecha 26-08-2019. del 001 a 1000. Secretaría contra la Violencia');
        doc.text(37, 262, 'Sexual, Explotación y Trata de Personas, NIT 7463923-4, Libro 4-ASCC Folio 115, Cuentadancia S1-38.');
		...
		doc.text(80, 268, ' Original--Expediente-Duplicado--Contabilidad');
			...
			doc.text(10, 256, 'Forma autorizada según Resolución de la Contraloría General de Cuentas No. F.O.-LM-257-2023 003748 número de Gestión 864770 de fecha 14-09-2023');
		doc.text(10, 259, 'correlativo 869-2023 de fecha 02-11-2023 Enváo Fiscal 4-ASCC 21284 de fecha 02-11-2023, del 1001 al 2000. Secretaría contra la Violencia');
        doc.text(30, 262, 'Sexual, Explotación y Trata de Personas, NIT 7463923-4, Libro 4-ASCC Folio 132, Cuentadancia 2022-100-101-18-030');
