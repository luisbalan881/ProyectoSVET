function datos_hoja_cupones44(year,mes,solicitud_id,dep_id){
  ...
  cp.forEach( function(valor, indice, array) {
         ...
         //	doc.setFillColor(255, 255, 255);
          ...
          //  doc.writeText(0, 255 ,'_________________________',{align:'center',width:215});
              doc.writeText(0, 260 ,'Elaborado_________________________                         Vo. Bo _________________________',{align:'center',width:215});
           ...
           // doc.writeText(0, 275 ,'_________________________',{align:'center',width:215});
              doc.writeText(0, 270 ,'Nombre y Firma de quien recibe los cupones___________________________________________',{align:'center',width:215});
