function add_formulario_km_fin(correlativo) {
    ...
    //    var logros=$('#logros').val();
     //   var actividades=$('#actividades').val();
        ...
        var kmInicial=$('#km_inicial').val();
		  var comb=$('#com_act').val();
		  var precio=$('#precio').val();
		  
		  console.log(precio);
        
      //  var total2=$('#almt').val(); //cent, precio
       // var total3=$('#cent').val();  
         ...
         especificacion=$(this).val();
          ...
          $.ajax({
                           ...
                           type: "POST",
                            ...
                            data: {c:c, dest:dest, kmInicial:kmInicial, comb:comb, precio:precio}, //f de fecha y u de estado.
