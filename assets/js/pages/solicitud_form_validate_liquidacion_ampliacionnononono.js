function add_formulario_ampliacion(userid, dep, correlativo) {
  jQuery('.js-validation-solicitud').validate({
      ...
      submitHandler: function(form){
       ...
       // soli_tiempo
        ...
        var total3=$('#cent').val();  
        var total4=$('#host').val(); 
        var ampliaciond=$('#ampliacion1').val();
        var ampliaciont=$('#ampliacion2').val();
        ...
        dur_en.each(function ()
      {
         ...
         var year = (new Date).getFullYear();
          ...
          $.ajax({
            ...
            type: "POST",
            url: "viaticos/php/add_solicitud_liquidacion_ampliada.php",
            data: {codigo:c, total:total1, total2:total2, total3:total3, total4:total4,ampliaciond:ampliaciond,ampliaciont:ampliaciont, objetivo:objetivo,logros:logros,actividades:actividades}, //f de fecha y u de estado.
                    ...
                    codigo= data;
                        ...
                        //  
                          ...
                          $.ajax({
                            ...
                            type: "POST",
                            url: "viaticos/php/add_solicitud_detalle_status.php",
