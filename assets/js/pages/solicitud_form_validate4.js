...
function add_formulario_anulacion(userid, dep, correlativo) {
  jQuery('.js-validation-solicitud').validate({
      ignore: [],
      errorClass: 'help-block animated fadeInDown',
      errorElement: 'div',
        ...
        dur_en.each(function ()
      {
         ...
         var year = (new Date).getFullYear();
          ...
          $.ajax({
            ...
            type: "POST",
            url: "compras/php/add_solicitud_anulacion.php",
            data: {codigo:c}, //f de fecha y u de estado.
                    ...
                    //alert(data);
                     ...
                     setTimeout(function(){
                                     ...
                                     setTimeout(function(){
                                                    ...
                                                    $('#loading1').fadeOut("slow");
                                                    $('#modal-remoto-lgg').modal('hide');
                                                      show_notificacion_warning("Anulado");
                                                  //get_horarios_usuario();
                                           }, 30);
                    ...
                    codigo= data;
                        ...
                        //  
                          ...
                          $.ajax({
                            ...
                            type: "POST",
                            url: "compras/php/add_solicitud_anulacion2.php",
                            data: {codigo:c}, //f de fecha y u de estado.
