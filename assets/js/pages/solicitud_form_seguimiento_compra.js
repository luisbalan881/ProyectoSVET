...
function add_formulario_aprobacion(userid, dep, correlativo) {
  jQuery('.js-validation-solicitud').validate({
      ignore: [],
      errorClass: 'help-block animated fadeInDown',
      errorElement: 'div',
        ...
        dur_en.each(function ()
      {
         ...
         var year = (new Date).getFullYear();
          ...
          $.ajax({
            ...
            type: "POST",
            url: "compras/php/add_solicitud_aprobacion.php",
            data: {codigo:c}, //f de fecha y u de estado.
                    ...
                    //alert(data);
                     ...
                     setTimeout(function(){
                                     ...
                                     setTimeout(function(){
                                                    ...
                                                    $('#loading1').fadeOut("slow");
                                                    $('#modal-remoto-lgg').modal('hide');
                                                      show_notificacion_success("Aprobado");
                    ...
                    codigo= data;
                        ...
                        //  
                          ...
                          $.ajax({
                            ...
                            type: "POST",
                            url: "compras/php/add_solicitud_aprobacion2.php",
                            data: {codigo:c,id:id}, //f de fecha y u de estado.
...
function add_formulario_modificar(userid, dep, correlativo) {
  jQuery('.js-validation-solicitud').validate({
      ignore: [],
      errorClass: 'help-block animated fadeInDown',
      errorElement: 'div',
        ...
        dur_en.each(function ()
      {
         ...
         var year = (new Date).getFullYear();
          ...
          $.ajax({
            ...
            type: "POST",
            url: "compras/php/add_solicitud_modificar0.php",
            data: {codigo:c}, //f de fecha y u de estado.
                    ...
                    //alert(data);
                     ...
                     setTimeout(function(){
                                     ...
                                     setTimeout(function(){
                                                    ...
                                                    $('#loading1').fadeOut("slow");
                                                    $('#modal-remoto-lgg').modal('hide');
                                                      show_notificacion_success("Editado");
				setTimeout( function() { window.location.href = "?ref=_500"; }, 1000);
                                                  //get_horarios_usuario();
                                           }, 30);
                    ...
                    codigo= data;
                        ...
                        //  
                          ...
                          $.ajax({
                            ...
                            type: "POST",
                            url: "compras/php/add_solicitud_modificar.php",
                            data: {codigo:c,id:id,soli_desc:soli_desc}, //f de fecha y u de estado.
