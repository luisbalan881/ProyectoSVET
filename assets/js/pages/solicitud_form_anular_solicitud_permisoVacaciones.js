function add_formulario_vacaciones_anular(userid, dep, correlativo) {
      ...
      submitHandler: function(form){
       ...
       // soli_tiempo
        ...
        //var fecha2=$('#soli_fecha2').val();
		 ...
		 var id_solicitante=$('#id_solicitante').val();// id_solicitante
        ...
        dur_en.each(function ()
      {
         ...
         var year = (new Date).getFullYear();
          ...
          $.ajax({
            ...
            type: "POST",
            url: "rrhh_permisos/php/add_solicitud2_vacaciones_anular.php",
            data: {c:c,dias_soli:dias_soli, id_user:id_user, dias_consumidos:dias_consumidos, id_periodo:id_periodo,id_solicitante:id_solicitante}, //f de fecha y u de estado.
                    ...
                    codigo= data;
                        ...
                        //  
                          ...
                          $.ajax({
                            ...
                            type: "POST",
                            url: "rrhh_permisos/php/add_solicitud_detalle_anulacion.php",
							data: {codigo:c, razon:razon}, //f de fecha y u de estado.
...
function add_formulario_vacaciones_retornar(userid, dep, correlativo) {
  jQuery('.js-validation-solicitud').validate({
      ignore: [],
      errorClass: 'help-block animated fadeInDown',
      errorElement: 'div',
        ...
        dur_en.each(function ()
      {
         ...
         var year = (new Date).getFullYear();
          ...
          $.ajax({
            ...
            type: "POST",
            url: "rrhh_permisos/php/add_solicitud2_vacaciones_retornar.php",
            data: {c:c,dias_soli:dias_soli, id_user:id_user, dias_consumidos:dias_consumidos, id_periodo:id_periodo,id_solicitante:id_solicitante}, //f de fecha y u de estado.
                    ...
                    codigo= data;
                        ...
                        //  
                          ...
                          $.ajax({
                            ...
                            type: "POST",
                            url: "rrhh_permisos/php/add_solicitud_detalle_anulacion2.php",
                            data: {codigo:c}, //f de fecha y u de estado.
