                                    ...
                                    setTimeout(function(){
                                     ...
                                     $("#message").addClass('alert alert-success');
									  ...
									  setTimeout(function(){
                                                    ...
                                                    $('#modal-remoto-lgg').modal('hide');
                                                      show_notificacion_success("Nombramiento Generado");
													  setTimeout( function() { window.location.href = "?ref=_79"; }, 1000);
...
function add_solicitudOficio(userid, dep) {
  jQuery('.js-validation-solicitud').validate({
      ignore: [],
      errorClass: 'help-block animated fadeInDown',
      errorElement: 'div',
      ...
      submitHandler: function(form){
       ...
       // soli_tiempo
        ...
        var fecha2=$('#soli_fecha2').val();
        var objetivo1=$('#objetivo').val();
	//var dep=$('#d_solicitantes').val();
        //var duracion1=$('#soli_tiempo2').val();
        var dur_en=$("#d_solicitantes option:selected");
        var lugar=$("#soli_lugar").val(); // luares
        ...
        dur_en.each(function ()
      {
         ...
         console.log(objetivo1);
          ...
          $.ajax({
            ...
            type: "POST",
            url: "oficios/php/add_solicitud_oficio.php",
            data: {objetivo1:objetivo1, lugar:lugar, especificacion:especificacion, id:id, year:year}, //f de fecha y u de estado.
                    ...
                    codigo= data;
					    ...
					    $('#message').fadeIn().html(data);
						  ...
						  setTimeout(function(){
                                                    ...
                                                    $('#loading1').fadeOut("slow");
                                                    $('#modal-remoto-lgg').modal('hide');
                                                      show_notificacion_success("Codigo de Oficio Generado");
