function add_formulario2(userid, dep, correlativo) {
  jQuery('.js-validation-solicitud').validate({
      ...
      highlight: function(e) {
          ...
          $("#boton_s_t1").removeClass('vibrar').addClass('vibrar');
      },
      success: function(e) {
          var elem = jQuery(e);

          elem.closest('.form-group').removeClass('has-error');
          $("#boton_s_t1").removeClass('vibrar');
          elem.closest('.help-block').remove();
        ...
        dur_en.each(function ()
      {
         ...
         var year = (new Date).getFullYear();
          ...
          $.ajax({
            ...
            type: "POST",
            url: "rrhh_permisos/php/add_solicitud_anular_solicitud.php",
                    ...
                    codigo= data;
                        ...
                        //  
                          ...
                          $.ajax({
                            ...
                            type: "POST",
                            url: "rrhh_permisos/php/add_solicitud_detalle_anular.php",
                            data: {codigo:c}, //f de fecha y u de estado.
