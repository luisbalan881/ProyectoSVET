          ...
          <div class="">
            ...
            <div class="block-content ">
              <form id="SolicitudForm" class="js-validation-solicitud form-horizontal form-style-10" method="POST" enctype="multipart/form-data">
                <h1>Crear No. de Oficio<span>Formulario de creación de Número de Oficio para Dirección/Unidad </span></h1>
				   ...
				   <div class="form-group">
                      <div class="col-xs-12">
                          <div class="form-material">
                              ...
                              <label for="destinatarios">Dirección/Unidad*</label>
                              <div class="input-group has-personalizado">
                                <span class="input-group-addon" ><span class="fa fa-bank"></span></span>
                                <select name="d_solicitantes" id="d_solicitantes"  multiple="multiple" data-placeholder="Seleccione Dirección/Unidad" class="chosen-select-width col-xs-12 form-control" multiple tabindex="6" required>
                                  <?php
                  ...
                  <div class="form-group">
                    <div class="col-xs-5">
                          ...
                          <div class="has-personalizado">
                            <label for="soli_lugar">Institución destino (Campo obligatorio)</label>
                            <div class="input-group has-personalizado">
                    ...
                    <div class="col-xs-12">
                          ...
                          <div class="has-personalizado">
                            <label for="objetivo">Asunto (Campo obligatorio)</label>
                            <div class="input-group has-personalizado">
                              <span class="input-group-addon" ><span class="si si-pencil"></span></span>
                  ...
                  <div class="form-group">
                    <div class="col-sm-12 text-center">
                        <button id="boton_s_t" class="btn btn-sm btn-primary btn-block" onclick="add_solicitudOficio(<?php echo $id ?>,<?php echo $persona->persona['dep_id']?>)" ><i id="loading1" class="fa fa-refresh fa-spin" style="display:none;"></i> Crear</button>
                    </div>
                  </div>
