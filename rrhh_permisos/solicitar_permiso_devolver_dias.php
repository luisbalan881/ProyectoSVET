<?php
    ...
    if (function_exists('login_check') && login_check() == true) :
        ...
        <head>
            ...
            <title>Anular Solicitud Vacaciones por Administrador</title>
            ...
            <script src="assets/js/pages/solicitud_form_anular_solicitud_permisoVacaciones.js"></script>
          ...
          <div class="">
            ...
            <div class="block-content ">
              <form id="SolicitudForm" class="js-validation-solicitud form-horizontal form-style-10" method="POST" enctype="multipart/form-data">
                <h1>Anular Solicitud <span> ¿Esta realmente seguro(a) de Anular esta solicitud? </span></h1>
					    ...
					    <div class="col-xs-12 col-sm-35">
                          ...
                          <div class="form-material ">
                            <div class="input-group has-personalizado">
                              <span class="input-group-addon" ><span class="fa fa-clock-o"></span></span>
                              <input class="form-control"  type="text"  id="id_solicitante" name="id_solicitante" value="<?php echo $bitacora['id_user_solicita']; ?>" disabled >
                            </div>
					  ...
					  <div class="col-xs-12 col-sm-35">
					   ...
					   <div class="col-xs-12 col-sm-35">
                          ...
                          <div class="form-material ">
                            ...
                            <label for="dias_solicitados">No. dias solicitados *</label>
                          </div>
                      </div>
					  ...
					  <div class="col-xs-12 col-sm-35">
					   ...
					   <div class="col-xs-12 col-sm-35">
                          ...
                          <div class="form-material ">
                            ...
                            <label for="soli_tiempo">Justificación de anulacion *</label>
                          </div>
                      </div> -
                  ...
                  <div class="form-group">
                    <div class="col-sm-12 text-center">  
                        <button id="boton_s_t" class="btn btn-sm btn-danger btn-block" onclick="add_formulario_vacaciones_anular(<?php echo $id ?>,<?php echo $persona->persona['dep_id']?>, <?php   echo $id2 ?>)" ><i id="loading1" class="fa fa-refresh fa-spin" style="display:none;"></i>Anular Solicitud</button>
                    </div>
                  </div>
