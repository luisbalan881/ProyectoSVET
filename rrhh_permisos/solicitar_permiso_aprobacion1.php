          ...
          <div class="">
            ...
            <div class="block-content ">
              <form id="SolicitudForm" class="js-validation-solicitud form-horizontal form-style-10" method="POST" enctype="multipart/form-data">
                <h1>Solicitud de retorno Días Enviada <span> Su solicitud fue enviara para su respectiva revisión</span></h1>
					  ...
					  <div class="col-xs-12 col-sm-35">
                          ...
                          <div class="form-material ">
                            ...
                            <label for="soli_tiempo">Fecha Ref1 *</label>
                          </div>
                      </div> 
					  ...
					  <div class="col-xs-12 col-sm-35">
                          ...
                          <div class="form-material ">
                            ...
                            <label for="soli_tiempo">Fecha Ref2 *</label>
                          </div>
                      </div> 
					   ...
					   <div class="col-xs-12 col-sm-35">
                          ...
                          <div class="form-material ">
                            ...
                            <label for="soli_tiempo">Fecha Ref3 *</label>
                          </div>
                      </div> 
					   ...
					   <div class="col-xs-12 col-sm-35">
                          ...
                          <div class="form-material ">
                            ...
                            <label for="dias_solicitados">No. dìas solicitado *</label>
                          </div>
                      </div>
						...
						<div class="col-xs-12 col-sm-35">
                          ...
                          <div class="form-material ">
                            ...
                            <label for="dias_consumidos">No. dìas consumidos *</label>
                          </div>
                      </div> 
					  ...
					  <div class="col-xs-12 col-sm-35">
                          ...
                          <div class="form-material ">
                            ...
                            <label for="soli_tiempo">No. dìas pendientes *</label>
                          </div>
                      </div> 
