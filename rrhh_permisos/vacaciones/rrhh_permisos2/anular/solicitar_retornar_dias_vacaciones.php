...
//echo $dept['status'];
          ...
          <div class="" id="myDIV">
            ...
            <div class="block-content ">
              ...
              <form id="SolicitudForm" class="js-validation-solicitud form-horizontal form-style-10" method="POST" enctype="multipart/form-data">
                <h1>Solicitar retornar Vacaciones<span>Formulario de solicitud de devoluciones de Vacaciones   </span></h1>
                      ...
                      <div class="col-xs-2 col-sm-25">
                          <div class="form-material">
                            <div class="input-group has-personalizado">
                              ...
                              <label for="soli_fecha">Fecha de referencia1</label>
                          </div>
                      </div>
                       ...
                       <div class="col-xs-2 col-sm-25">
                          <div class="form-material">
                            <div class="input-group has-personalizado">
                              ...
                              <label for="soli_fecha2">Fecha de referencia2</label>
                          </div>
                      </div>
                       <div class="col-xs-2 col-sm-25">
                          <div class="form-material">
                            <div class="input-group has-personalizado">
                              ...
                              <label for="soli_fecha3">Fecha de referencia3</label>
                          </div>
                      </div>
  ...
  <div class="col-xs-1 col-sm-25">
                          <div class="form-material ">
                            ...
                            <label for="soli_tiempo">cantidad de días a retornar*</label>
                          </div>
                      </div>
 ...
 <div class="form-group">
                      <div class="col-xs-12">
                          <div class="form-material">
                              ...
                              <div class="input-group has-personalizado">
                                ...
                                <select name="d_solicitantes" id="d_solicitantes"  multiple="multiple" data-placeholder="Seleccionar el periodo" class="chosen-select-width col-xs-12 form-control" multiple tabindex="6" required>
                                  <?php
                  ...
                  <div class="form-group">
                    <div class="col-sm-12 text-center">
                        <button id="boton_s_t" class="btn btn-sm btn-primary btn-block" onclick="add_solicitud2(<?php echo $id ?>,<?php echo $persona->persona['dep_id']?>)"  disabled><i id="loading1" class="fa fa-refresh fa-spin" style="display:none;"></i> Crear Solicitud</button>
                    </div>
                  </div>
