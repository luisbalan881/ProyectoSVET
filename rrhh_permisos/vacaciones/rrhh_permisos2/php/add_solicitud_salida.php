...
$sql = "INSERT INTO rrhh_solicitud (justificacion,fecha_inicio,fecha_final,fecha_retorno,dias_solicitado,status,dias_consumidos_user,pendientes,periodo,id_periodo, id_user_solicita) VALUES (?,?,?,?,?,?,?,?,?,?,?)";
$q = $pdo->prepare($sql);
$q->execute(array($justifiacion,$date1,$date2,$date3,$duracion1,$status,$dias_consumidos_user,$pendientes,$periodo,$id_periodo, $id));
$Id = $pdo->lastInsertId();
Database::disconnect();
