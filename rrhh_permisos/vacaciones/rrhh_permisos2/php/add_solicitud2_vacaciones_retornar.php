...
$id_solicitante=$_POST['id_solicitante']; //id_solicitante
...
$sql1 = "UPDATE rrhh_periodo_usuario SET dias_consumidos=? WHERE id_periodo_user=? and id_usuario=?";  
$q1 = $pdo->prepare($sql1);
$q1->execute(array($dias_a_actualizar,$id_periodo,$id_solicitante));   

/////////////////////////////////actualizar estatus de solicitud//////////////////////

//$sql11 = "UPDATE rrhh_solicitud SET status=?
  //      WHERE id_solicitud=?";  
//$q11 = $pdo->prepare($sql11);
//$q11->execute(array($status,$inst_id));  
