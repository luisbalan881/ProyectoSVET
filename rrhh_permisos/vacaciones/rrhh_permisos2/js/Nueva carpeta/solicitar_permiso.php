<?php
    ...
    if (function_exists('login_check') && login_check() == true) :
        if ($u->hasPrivilege('crearSolicitudTransporte') ) :
			...
			$periodo_user_fecha_fin = periodo_user_fecha_fin($id);
				   ...
				   <div class="col-xs-1 col-sm-25">
					     ...
					     <div class="col-xs-1 col-sm-25">
                          <div class="form-material ">
                            <div class="input-group has-personalizado">
                              <span class="input-group-addon" ><span class="fa fa-clock-o"></span></span>
                              <input class="form-control"  type="number"  id="pendientes1" name="pendientes1" value="<?php echo $pendientes['pendientes'] ?>" disabled >
                            </div>
					  ...
					  <div class="col-xs-1 col-sm-25">
                          <div class="form-material ">
                            <div class="input-group has-personalizado">
                              <span class="input-group-addon" ><span class="fa fa-clock-o"></span></span>
                              <input class="form-control"  type="number"  id="dias_restantes" name="dias_restantes" value="<?php echo $periodo_user_calculo['dias'] ?>" disabled >
                            </div>
