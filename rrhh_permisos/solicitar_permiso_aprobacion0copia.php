          ...
          <div class="">
            ...
            <div class="block-content ">
              <form id="SolicitudForm" class="js-validation-solicitud form-horizontal form-style-10" method="POST" enctype="multipart/form-data">
                <h1>Validar Solicitud <span> ¿Esta realmente seguro(a) de autorizar esta solicitud? si lo valida de habilitara su descarga</span></h1>
					  ...
					  <div class="col-xs-12 col-sm-35">
					   ...
					   <div class="col-xs-12 col-sm-35">
                          ...
                          <div class="form-material ">
                            ...
                            <label for="dias_solicitados">No. dias *</label>
                          </div>
                      </div>
