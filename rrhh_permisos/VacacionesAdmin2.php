...
if (function_exists('login_check') && login_check()):
   //  if (usuarioPrivilegiado()->hasPrivilege('leerViaticos')) :
    ...
    //    $nombramientos = nombramientos();
		  $solicitud_permiso = permiso_salida_admin2($user_id);
     ...
     <div class="row items-push">
         <div class="col-sm-7">
             <h1 class="page-heading">
                 SOLICITUDES DE PERMISOS O PASES DE SALIDA
             </h1>
         </div>
         <div class="col-sm-5 text-right hidden-xs">
             <ol class="breadcrumb push-10-t">
                 <li>CONTROL DE SOLICITUDES DE SALIDA
             </h1></li>
                 <li><a class="link-effect" href="#">DE PERMISOS O PASES DE SALIDA
             </h1>  </a></li>
             </ol>
         </div>
     </div>
 ...
 <div class="content content-boxed">
     ...
     <div class="block">
         <div class="block-header bg-gray-lighter">
           ...
           <h3 class="block-title">Solicitudes de permisos o pases de salida
             </h1></h3>
         </div>
             ...
             <table class="table table-bordered table-condensed table-striped js-dataTable-directorio" >
                 <thead>
                     <tr>
                         ...
                         <th class="hidden-xs text-center">Hora finalización</th>
                     ...
                     <?php
                         ...
                         //foreach ($personas as $persona){
                           // if($persona['ext_id'] > 0 && $nombramiento['user_status'] == 1){
                            ...
                            echo '<div class="btn-group">';
                                ...
                                {
                                 echo '<span data-toggle="tooltip" title="Autorizar Permiso"><a class="btn btn-default"  title="Autorizar Permiso"  data-toggle="modal" data-target="#modal-remoto" href="rrhh_permisos/solicitar_permiso_aprobacion2.php?id='.$nombramiento['id_solicitud'].'"><i class="fa fa-check-square" aria-hidden="true"></i></a></span>';
                                  }
                       ...
                       //     echo '<span data-toggle="tooltip" title="Revisar"><a class="btn btn-default" '.(($nombramiento['status'] == 1 )?' href="almacen/requisicion_impresion.php?id='.$nombramiento['id_nombramiento'].'" target="_blank" ':'href="#" disabled').'><i class="fa fa-print text-info"></i></a></span>';
                           ...
                           /*    echo '<button title="liquidacion sin Anticipo" class="btn btn-personalizado outline" title="Descargar" ';
                             if ($nombramiento['status'] == 5 and ($user_id == 177 or $user_id==9966) )  // 177 usurio nitzia montejo  9966 alejandro quevedo
                                {
                            ...
                            echo '<button title="Imprimir Constancia" class="btn btn-personalizado outline" title="Descargar" ';
                             ...
                             if ($nombramiento['status'] < 4 and ($user_id == 9966 or $user_id==177) )  
                                {
                             ...
                             if (($nombramiento['status'] == 4 or $nombramiento['status'] == 5) and ($user_id == 9966 or $user_id==177) )
                                {
                             ...
                             if ($nombramiento['status'] == 3 and ($user_id == 9966 or $user_id==177))
                                {
                             ...
                             if ($nombramiento['status'] >= 6 and ($user_id == 9966 or $user_id==177))
                                {
                             ...
                             if ($nombramiento['status'] == 1)
                                ...
                                echo '><i class="fa fa-download"></i></button>';
                                 ...
                                 if ($nombramiento['status'] == 0 ){
                                    ...
                                    echo '<span class="label label-success">Autorizado</span> </td>';
                                    //echo'-liquidado';
                                }
