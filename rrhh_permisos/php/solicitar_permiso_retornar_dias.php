          ...
          <div class="">
            ...
            <div class="block-content ">
              <form id="SolicitudForm" class="js-validation-solicitud form-horizontal form-style-10" method="POST" enctype="multipart/form-data">
                <h1>Solicitud de Retorno de Días de Vacaciones <span> ¿Esta realmente seguro(a) de Aceptar esta solicitud? </span></h1>
                  ...
                  <div class="form-group">
                    <div class="col-sm-12 text-center">  
                        <button id="boton_s_t" class="btn btn-sm btn-danger btn-block" onclick="add_formulario_vacaciones_retornar(<?php echo $id ?>,<?php echo $persona->persona['dep_id']?>, <?php   echo $id2 ?>)" ><i id="loading1" class="fa fa-refresh fa-spin" style="display:none;"></i>Retornar días</button>
                    </div>
                  </div>
