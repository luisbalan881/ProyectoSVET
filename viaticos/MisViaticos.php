				...
				//				
                             ...
                             //if ($nombramiento['status'] >= 1  or $nombramiento['status'] == -1)
							  ...
							  if ($nombramiento['status'] >= 1)
                                ...
                                {
                                 echo 'onclick="HTMLtoPDF1('.$nombramiento['id_nombramiento'].')"';//HTMLtoPDF2
								...
								//
								    echo '<button title="Imprimir Asignación de actividades" class="btn btn-personalizado outline" title="Descargar" ';
                             //if ($nombramiento['status'] >= 1  or $nombramiento['status'] == -1)
								 
							  if ($nombramiento['status'] == -1)
							 
                                {
                                 echo 'onclick="HTMLtoPDF2('.$nombramiento['id_nombramiento'].')"';//HTMLtoPDF2
				  ...
				  if ($nombramiento['status'] ==4)
                                ...
                                if ($nombramiento['status'] == 0 ){
                                   ...
                                   echo '<span class="label label-info">Asignación de Actividad generado <a class="btn btn-default"  title="Editar Nombramiento"  data-toggle="modal" data-target="#modal-remoto-lgg1" href="viaticos/solicitar_nombramiento_editable.php?id='.$nombramiento['id_nombramiento'].'"><i class="fa fa-pencil text-warning"></i></a> </span> </td>';
                                    //echo'-liquidado';
                                }
