...
<head>
    ...
    <script src="assets/js/plugins/jspdf/jspdf.js"></script>
            ...
            <script src="assets/js/plugins/jspdf/pdfFromHTML1.js"></script>
			  <script src="assets/js/plugins/jspdf/pdfFromHTML_justificacion.js"></script>
                          ...
                          /*  echo '<button title="Imprimir Constancia" class="btn btn-personalizado outline" title="Descargar" ';
                             ...
                             */  
                             ...
                             if ($nombramiento['status'] == 7)
                                {
                                 echo 'onclick="HTMLtoPDFV_liquiidacion_ampliacion('.$nombramiento['id_nombramiento'].')"';
                                ...
                                // liquidar test
                           /*      echo '<button title="Imprimir justificación de ampliación " class="btn btn-personalizado outline" title="Descargar" ';
                             if ($nombramiento['status'] == 7)
                                {
                                 echo 'onclick="HTMLtoPDFJUSTIFICACION('.$nombramiento['id_nombramiento'].')"';
				...
				*/
				...
				//				
                          ...
                          //  }
                                ...
                                {
                                 echo '<span data-toggle="tooltip" title="Liquidar"><a class="btn btn-default"  title="nota importante: este formulario no es para liquidar con ampliación debe realizar la solicitud a finaciero extención 111, para poder liquidar de la forma correcta, y que sea habilitado el formulario de liquidación con ampliación"  data-toggle="modal" data-target="#modal-remoto" href="viaticos/solicitar_viaticos_2.php?id='.$nombramiento['id_nombramiento'].'"><i class="fa fa-pencil text-warning"></i></a></span>';
                                  }
                                   if ($nombramiento['status'] == 6)
                                {
                                 echo '<span data-toggle="tooltip" title="Liquidar con amplicacion"><a class="btn btn-default"  title=" liquidación"  data-toggle="modal" data-target="#modal-remoto" href="viaticos/liquidar_con_ampliacion.php?id='.$nombramiento['id_nombramiento'].'"><i class="fa fa-pencil text-warning"></i></a></span>';
                                  }
                                ...
                                if ($nombramiento['status'] == 0 ){
                                    ...
                                    echo '<span class="label label-success">Liquidado Sin Anticipo<a class="btn btn-default"  title="Editar liquidación sin anticipo"  data-toggle="modal" data-target="#modal-remoto" href="viaticos/update_liquidar_sin_anticipo.php?id='.$nombramiento['id_nombramiento'].'"><i class="fa fa-pencil text-warning"></i></a> </span> </td>';
                                    //echo'-liquidado';
                                }
                                    ...
                                    echo '<span class="label label-success">Liquidado con ampliacion<a class="btn btn-default"  title="Editar liquidacion con ampliacion"  data-toggle="modal" data-target="#modal-remoto" href="viaticos/uptdate_liquidar_con_ampliacion.php?id='.$nombramiento['id_nombramiento'].'"><i class="fa fa-pencil text-warning"></i></a> </span> </td>';
                                    //echo'-liquidado';
                                }
