...
<input class="form-control input-sm" type="number" id="totalgt"  readonly> 
            ...
            <div class="block-content ">
              <form id="SolicitudForm" class="js-validation-solicitud form-horizontal form-style-10" method="POST" enctype="multipart/form-data">
                <h1>Formulario de Liquidación <span> Instrucciones generales: 1) Llenar los campos según lo facturado No sobrepasando los valores limites permitidos por día.  2) En caso de No utilizar algún campo, colocar un  cero "0" y no dejarlo en vacio.  3)Llenar los campos de detalle de comisión 4) Antes de dar click a LIQUIDAR verificar los valores ingresados, dado que no se podrá modificar 5) AL darle click a liquidar se genera automáticamente los formularios de Detalle de comisión y liquidación. </span> </h1>
