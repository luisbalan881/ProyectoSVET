     ...
     <div class="row items-push">
         <div class="col-sm-7">
             <h1 class="page-heading">
                 CONTROL DE ASIGNACIONES DE ACTIVIDADES
             </h1>
         </div>
         <div class="col-sm-5 text-right hidden-xs">
             <ol class="breadcrumb push-10-t">
                 <li>CONTROL DE MIS SOLICITUDES DE ACTIVIDADES</li>
                 <li><a class="link-effect" href="#">MIS ASIGNACIONES DE ACTIVIDADES </a></li>
             </ol>
         </div>
     </div>
 </div>
 ...
 <div class="content content-boxed">
     ...
     <div class="block">
         <div class="block-header bg-gray-lighter">
           ...
           <h3 class="block-title">todos Nombramientos </h3>
         </div>
                             ...
                             if ($nombramiento['status'] == -1 )
								...
								/////////////////
                                 ...
                                 if ($nombramiento['status'] == 0 ){
                                    ...
                                    echo '<span class="label label-info">Asignación de Actividades Generado</span> </td>';
                                    //echo'-liquidado';
                                }
