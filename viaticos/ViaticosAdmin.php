             ...
             <table class="table table-bordered table-condensed table-striped js-dataTable-directorio" >
                       ...
                       //     echo '<span data-toggle="tooltip" title="Revisar"><a class="btn btn-default" '.(($nombramiento['status'] == 1 )?' href="almacen/requisicion_impresion.php?id='.$nombramiento['id_nombramiento'].'" target="_blank" ':'href="#" disabled').'><i class="fa fa-print text-info"></i></a></span>';
                           ...
                           // if (permiso_perm(4) && usuarioPrivilegiado()->hasPrivilege('crearCupon') || usuarioPrivilege('Configuracion'))
                            //{
                             ...
                             if ($nombramiento['status'] == 5 and ($user_id == 177 or $user_id==9966) )  // 177 usurio nitzia montejo  9966 xiomara masa  1022Alwxander hernadez
                                {
                            ...
                            // if ($nombramiento['status'] == 1 or $nombramiento['status'] == 2 or $nombramiento['status'] == 3 or $nombramiento['status'] == 4 and ($user_id == 9966 or $user_id==177) )  
							  if ($nombramiento['status'] < 4 and ($user_id == 9966 or $user_id==177) )  
                                {
									//$nombramiento['status'] == 4 or $nombramiento['status'] == 5  77 es  // if ($nombramiento['status'] < 4 and ($user_id == 9966 or $user_id==177) )  
                                ...
                                echo '><i class="fa fa-download"></i></button>';
								  ...
								  echo '<button title="Imprimir Anticipo" class="btn btn-personalizado outline" title="Descargar" ';
                             if ($nombramiento['status'] == 7 and ($user_id == 9966 or $user_id==177) )  
                                {
                                 echo 'onclick="HTMLtoPDFV11('.$nombramiento['id_nombramiento'].')"';
				...
				//				
                          ...
                          //  }
                                  ...
                                  if ($nombramiento['status'] == 1 and ($user_id == 9966 or $user_id==177) )
                                {
                                   ...
                                   if ($nombramiento['status'] == 2 and ($user_id == 9966 or $user_id==177) )
                                {
                                 echo '<span data-toggle="tooltip" title="Anular Anticipo"><a class="btn btn-default"  title="Anular Formulario Anticipo"  data-toggle="modal" data-target="#modal-remoto" href="viaticos/sin_anticipio.php?id='.$nombramiento['id_nombramiento'].'"><i class="fa fa-times" aria-hidden="true"></i></a></span>';
                                  ...
                                  //echo '<span data-toggle="tooltip" title="Anular"><a class="btn btn-default" ' . (($requisicion['req_status'] == 0) ? 'href="#" disabled' : ' data-toggle="modal" data-target="#modal-remoto" href="almacen/requisicion_anular.php?id='.$requisicion['req_id'].'"') . ' ><i class="fa fa-times text-danger"></i></a></span>';
                                    ...
                                    if ($nombramiento['status'] == 9 and ($user_id == 9966 or $user_id==177) )
                                {
							...
							/*	else if ($nombramiento['status'] == -1 ){
                                    echo '<span class="label label-info">Asignación generda</span> </td>';
                                    //echo'-nueva solicitud de ampliacion';
                                }*/
