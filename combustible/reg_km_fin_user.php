...
// bitacora_info_precio_reg (
 
  $id_vehi= $bitacora['vehiculo_id'];
 // echo  $id_vehi;
 // echo  " el precio del combustible de este vehiculo es:";
 
$ultimo=bitacora_info_precio_reg($id_vehi);
//echo $ultimo['precio_comb'];

//echo $bitacora['precio_com'];
        ?>
        <!DOCTYPE html>
        <html>
        <head>
...
<link rel="stylesheet" type="text/css" href="../alertify/css/alertify.css">
 ...
 <div class="form-group">
                ...
                <div class="col-xs-6">
                  <div class="form-material">
                      ...
                      <div class="input-group has-personalizado">
                           ...
                           <input class="form-control input-sm" type="number"   id="precio"  min="1" max="60" step="any"   value="<?php echo $ultimo['precio_comb']; ?>">  

                    </div>
                                            
                      <label for="precio">Precio combustible</label>
                  </div>
                </div>       
  ...
  <select class="form-control input-sm" name="com_act" id="com_act">
    ...
    <option value="50" selected>50%</option> <!-- Opción por defecto -->
	...
	<option value="100">100%</option>
                          ...
                          <label for="com_act">Porcentaje Combustible Actual</label>                  
                  ...
                  <div class="form-group">
                    <div class="col-sm-12 text-center">  
                        <button id="boton_s_t" class="btn btn-sm btn-success btn-block" onclick="add_formulario_km_fin( <?php   echo $id2 ?>)" disabled><i id="loading1" class="fa fa-refresh fa-spin" style="display:none;"></i> Registrar kilometraje final</button>
                    </div>
                  </div>
