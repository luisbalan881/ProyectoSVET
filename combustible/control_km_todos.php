...
<html>
<head>
    <title>Registros de Kilometrajes </title>
    <!-- Page JS Plugins CSS -->
 ...
 <div class="content content-boxed">
     ...
     <div class="block">
         <div class="block-header bg-gray-lighter">
           ...
           <h3 class="block-title">Listado de Registros de kilometrajes</h3>
         </div>
                     ...
                     <tr>
                         ...
                         <th class="hidden-xs text-center">km final</th>
                          ...
                          <th class="hidden-xs text-center">km recorridos</th>
						   <th class="hidden-xs text-center"> % de combustible</th>
						   <th class="hidden-xs text-center">Precio de combustible</th>
                       ...
                       foreach ($list_bitacora as $list_bitacora1){
                         //foreach ($personas as $persona){
                           // if($persona['ext_id'] > 0 && $list_bitacora1['user_status'] == 1){
                                ...
                                echo '<td class="hidden-xs">'.$list_bitacora1['Destino'].'</td>';
                                     echo '<td class="hidden-xs">'.$list_bitacora1['km_inicial'].'</td>';
                                       echo '<td class="hidden-xs">'.$list_bitacora1['km_final'].'</td>';
										...
										// echo '<td class="hidden-xs">'.$list_bitacora1['porcentaje_comb'].' <span>%</span></td>';
                            ...
                            if($list_bitacora1['porcentaje_comb']==0) //id_usuario
                            {
							 ...
							 else if($list_bitacora1['porcentaje_comb']==10 )
                            {
                            ...
                            echo ' <div class="progress">
                                                                <div class="progress-bar progress-bar-danger" role="progressbar" style="width:10.00%;"></div>
                                                                10% combustible 
                                                            </div>';
                            }
														 else if($list_bitacora1['porcentaje_comb']==20 )
                            {
                            // echo '<span data-toggle="tooltip" title="finalizar"><a class="btn btn-default" data-toggle="modal" data-target="#modal-remoto" href="proyectos/modificar_status_finalizado.php?id='.$infProyecto['id_proyecto'].'"><i class="fa fa-pencil text-warning">Estado actual:  En proceso </i></a></span>';
                            echo ' <div class="progress">
                                                                <div class="progress-bar progress-bar-danger" role="progressbar" style="width:20.00%;"></div>
                                                                20% combustible 
                                                            </div>';
                            }
														 else if($list_bitacora1['porcentaje_comb']==25 )
                            {
                            // echo '<span data-toggle="tooltip" title="finalizar"><a class="btn btn-default" data-toggle="modal" data-target="#modal-remoto" href="proyectos/modificar_status_finalizado.php?id='.$infProyecto['id_proyecto'].'"><i class="fa fa-pencil text-warning">Estado actual:  En proceso </i></a></span>';
                            echo ' <div class="progress">
                                                                <div class="progress-bar progress-bar-danger" role="progressbar" style="width:25.00%;"></div>
                                                                25% combustible 
                                                            </div>';
                            }
														 else if($list_bitacora1['porcentaje_comb']==30 )
                            {
                            // echo '<span data-toggle="tooltip" title="finalizar"><a class="btn btn-default" data-toggle="modal" data-target="#modal-remoto" href="proyectos/modificar_status_finalizado.php?id='.$infProyecto['id_proyecto'].'"><i class="fa fa-pencil text-warning">Estado actual:  En proceso </i></a></span>';
                            echo ' <div class="progress">
                                                                <div class="progress-bar progress-bar-danger" role="progressbar" style="width:30.00%;"></div>
                                                                30% combustible 
                                                            </div>';
                            }
														 else if($list_bitacora1['porcentaje_comb']==40 )
                            {
                            // echo '<span data-toggle="tooltip" title="finalizar"><a class="btn btn-default" data-toggle="modal" data-target="#modal-remoto" href="proyectos/modificar_status_finalizado.php?id='.$infProyecto['id_proyecto'].'"><i class="fa fa-pencil text-warning">Estado actual:  En proceso </i></a></span>';
                            echo ' <div class="progress">
                                                                <div class="progress-bar progress-bar-danger" role="progressbar" style="width:40.00%;"></div>
                                                                40% combustible 
                                                            </div>';
                            }
							 else if($list_bitacora1['porcentaje_comb']==50 )
                            {
                            // echo '<span data-toggle="tooltip" title="finalizar"><a class="btn btn-default" data-toggle="modal" data-target="#modal-remoto" href="proyectos/modificar_status_finalizado.php?id='.$infProyecto['id_proyecto'].'"><i class="fa fa-pencil text-warning">Estado actual:  En proceso </i></a></span>';
                            echo ' <div class="progress">
                                                                <div class="progress-bar progress-bar-warning" role="progressbar" style="width:50.00%;"></div>
                                                                50% combustible 
                                                            </div>';
                            }
							 else if($list_bitacora1['porcentaje_comb']==60 )
                            {
                            // echo '<span data-toggle="tooltip" title="finalizar"><a class="btn btn-default" data-toggle="modal" data-target="#modal-remoto" href="proyectos/modificar_status_finalizado.php?id='.$infProyecto['id_proyecto'].'"><i class="fa fa-pencil text-warning">Estado actual:  En proceso </i></a></span>';
                            echo ' <div class="progress">
                                                                <div class="progress-bar progress-bar-warning" role="progressbar" style="width:60.00%;"></div>
                                                                60% combustible 
                                                            </div>';
                            }
							 else if($list_bitacora1['porcentaje_comb']==70 )
                            {
                            // echo '<span data-toggle="tooltip" title="finalizar"><a class="btn btn-default" data-toggle="modal" data-target="#modal-remoto" href="proyectos/modificar_status_finalizado.php?id='.$infProyecto['id_proyecto'].'"><i class="fa fa-pencil text-warning">Estado actual:  En proceso </i></a></span>';
                            echo ' <div class="progress">
                                                                <div class="progress-bar progress-bar-warning" role="progressbar" style="width:70.00%;"></div>
                                                                70% combustible 
                                                            </div>';
                            }
							
							 else if($list_bitacora1['porcentaje_comb']==75 )
                            {
                            // echo '<span data-toggle="tooltip" title="finalizar"><a class="btn btn-default" data-toggle="modal" data-target="#modal-remoto" href="proyectos/modificar_status_finalizado.php?id='.$infProyecto['id_proyecto'].'"><i class="fa fa-pencil text-warning">Estado actual:  En proceso </i></a></span>';
                            echo ' <div class="progress">
                                                                <div class="progress-bar progress-bar-success" role="progressbar" style="width:75.00%;"></div>
                                                                75% combustible 
                                                            </div>';
                            }
							 else if($list_bitacora1['porcentaje_comb']==80 )
                            {
                            // echo '<span data-toggle="tooltip" title="finalizar"><a class="btn btn-default" data-toggle="modal" data-target="#modal-remoto" href="proyectos/modificar_status_finalizado.php?id='.$infProyecto['id_proyecto'].'"><i class="fa fa-pencil text-warning">Estado actual:  En proceso </i></a></span>';
                            echo ' <div class="progress">
                                                                <div class="progress-bar progress-bar-success" role="progressbar" style="width:80.00%;"></div>
                                                                80% combustible 
                                                            </div>';
                            } else if($list_bitacora1['porcentaje_comb']==90 )
                            {
                            // echo '<span data-toggle="tooltip" title="finalizar"><a class="btn btn-default" data-toggle="modal" data-target="#modal-remoto" href="proyectos/modificar_status_finalizado.php?id='.$infProyecto['id_proyecto'].'"><i class="fa fa-pencil text-warning">Estado actual:  En proceso </i></a></span>';
                            echo ' <div class="progress">
                                                                <div class="progress-bar progress-bar-success" role="progressbar" style="width:90.00%;"></div>
                                                                90% combustible 
                                                            </div>';
                            }
							 
                            else if($list_bitacora1['porcentaje_comb']==100.00)
                            {
                           ...
                           /* else 
                            {
                             ...
                             echo '</td>';
										 	 ...
										 	 echo '<td class="hidden-xs">'.$list_bitacora1['precio_comb'].'</td>';
