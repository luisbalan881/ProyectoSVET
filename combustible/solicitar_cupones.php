                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-4">
                        <div class="form-material">
                            ...
                            <label for="user_mail">Rendimiento</label>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-10">
                        <div class="form-material">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" id="destino" placeholder="Coloca el destino">
                            </div>

                            <label for="user_mail">Destino</label>
                        </div>
                    </div>
                    ...
                    <div class="">
                        ...
                        <table id="tb_solicitar_cupones" class="table  display nowrap" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                // <p><label>Contrase�a: <input type="password" name="pass"></label></p>
