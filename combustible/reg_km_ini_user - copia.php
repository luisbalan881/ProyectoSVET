                    ...
                    <div class="col-xs-5">
                          ...
                          <div class="has-personalizado">
                            ...
                            <div class="input-group has-personalizado">
                              ...
                              <textarea class="form-control" id="soli_lugar" name="soli_lugar" maxlength="200" rows="1"  required></textarea>
                            </div>
                ...
                <div class="form-group">
                    <div class="col-xs-5">
                          ...
                          <div class="has-personalizado">
                            ...
                            <div class="input-group has-personalizado">
                              <span class="input-group-addon" ><span class="si si-pencil"></span></span>
                              <textarea class="form-control" id="motivo" name="motivo" maxlength="200" rows="1"  required></textarea>
                            </div>
