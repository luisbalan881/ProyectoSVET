    ...
    if (function_exists('login_check') && login_check() == true) :
        if (usuarioPrivilegiado()->hasPrivilege('leerCupon')) :
         ...
         $carro = get_carro_por_solicitud_by_id($year,$mes,$solicitud,$vehiculo,$dep_id);
		   ...
		   // funcion consulta por id vehiculo
		 $km_final_by_id = get_carro_por_solicitud_by_bitacora ($vehiculo); //get_carro_por_solicitud_by_solicitud
		//  $km_final_soli = get_carro_por_solicitud_by_solicitud ($solicitud);
      ...
      //   echo 'kilometraje inicial a Registrar:';
        ...
        <body>
				...
				<div class="col-xs-4 text-center">
                  <div class="form-material">
                    <div class="input-group has-personalizado">
                        <span class="input-group-addon" ><span>kilometraje inicial a registrar</span></span>
                      <input class="form-control input-sm"  type="number"  id="km_ini" name="km_ini" value="<?php   echo  $carro['km_ini'];  ?>" disabled >
                    </div>
                  </div>
                </div>
			...
			<div class="col-xs-4 text-center">
                  <div class="form-material">
                    <div class="input-group has-personalizado">
                        <span class="input-group-addon" ><span>kilometraje final a registrar</span></span>
                      <input class="form-control input-sm"  type="number"  id="km_fin" name="km_fin" value="<?php   echo $km_final_by_id['maxKm_final'];  ?>" disabled >
                    </div>
                  </div>
                </div>	
