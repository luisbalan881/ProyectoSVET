...
$sql0= "SELECT MAX(id_bitacora)+1 as bitacora_id FROM vp_bitacora_vehiculo";
$p0 = $pdo->prepare($sql0);
...
where vp_solicitud_cupon_vehiculo.vehiculo_id=? AND vp_solicitud_cupon.estado_solicitud=2";
$p1 = $pdo->prepare($sql1);
