...
$sql1 = "INSERT INTO vp_solicitud_cupon_vehiculo (km_ini, year,mes,solicitud_id,vehiculo_id,dep_id,monto,conductor_id,destino)VALUES(?,?,?,?,?,?,?,?,?)";
$q1 = $pdo->prepare($sql1);
$q1->execute(array($km, $year, $mes, $solicitud, $vehiculo, $persona['dep_id'], $monto, $conductor, $destino));
Database::disconnect();
