      ...
      if(permiso_perm(7) || permiso_perm(3) && usuarioPrivilegiado()->hasPrivilege('crearCupon') || usuarioPrivilegiado()->hasPrivilege('Configuracion'))
      {
        ...
        <head>
            ...
            <script src="assets/js/plugins/jspdf/hoja_cupones.js"></script>
			  <script src="assets/js/plugins/jspdf/hoja_cupones22.js"></script>
			   <script src="assets/js/plugins/jspdf/hoja_cupones44.js"></script>
                      ...
                      <tbody>
                        ...
                        foreach ($solicitudes as $s){
                                      ...
                                      //  {
										  ...
										  echo '<button  title="autorización de entrega mayores" class="btn btn-personalizado outline"  title="Descargar" ';
                                          if($s['estado_solicitud']==2 )
                                          {
                                            echo 'onclick="datos_hoja_cupones2('.$s['year'].','.$m.','.$s['solicitud_id'].','.$s['dep_id'].')"  ';
                                          }
                                          else{
                                            echo 'disabled';
                                          }
										   ...
										   echo '<button  title="solicitud mayores" class="btn btn-personalizado outline"  title="Descargar" ';
                                          if($s['estado_solicitud']==2 )
                                          {
                                            echo 'onclick="datos_hoja_cupones44('.$s['year'].','.$m.','.$s['solicitud_id'].','.$s['dep_id'].')"  ';
                                          }
                                          else{
                                            echo 'disabled';
                                          }
                                     ...
                                     //   }
                                      ...
                                      //  if(permiso_perm(1) && usuarioPrivilegiado()->hasPrivilege('crearCupon')  || usuarioPrivilegiado()->hasPrivilege('Configuracion'))
                                       // {
                                      ...
                                      //  {
                                       ...
                                       // }
                                        ...
                                        //
											...
											// establecer comision ojo ojo se des mj
