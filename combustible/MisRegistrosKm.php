                          ...
                          //  }
                              ...
                              //  if ($list_bitacora1['status'] == 0 ){
                                ...
                                //}  
                                 if ($list_bitacora1['status'] == 1 )
                                {
                                 echo '<span data-toggle="tooltip" title="registra KM final"><a class="btn btn-default"  title="Registrar Km final"  data-toggle="modal" data-target="#modal-remoto-lgg" href="combustible/reg_km_fin_user.php?id='.$list_bitacora1['id_bitacora'].'"><i class="fa fa-eye text-info"></i></a></span>';
                                  }
                                    ...
                                    echo '<span class="label label-primary">KM Registrado   <a class="btn btn-default"  title="Modificar destino"  data-toggle="modal" data-target="#modal-remoto-lgg" href="combustible/reg_km_fin_user_editable.php?id='.$list_bitacora1['id_bitacora'].'"><i class="fa fa-pencil text-warning"></i></a></span> </td>';
                                    //echo'-liquidado';
                                }
                               else if ($list_bitacora1['status'] == 3 ){
                                    echo '<span class="label label-primary">KM Registrado con destino modificado <a class="btn btn-default"  title="Modificar destino"  data-toggle="modal" data-target="#modal-remoto-lgg1" href="combustible/reg_km_fin_user_editable.php?id='.$list_bitacora1['id_bitacora'].'"><i class="fa fa-pencil text-warning"></i></a></span> </td>';
                                    //echo'-liquidado';
                                }
                                 if ($list_bitacora1['status'] == 0 ){
                                    echo '<span class="label label-warning"> Anulado</span> </td>';
