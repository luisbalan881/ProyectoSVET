...
function evaluar_monto(monto){
  if(monto == 50 || monto == 100  || monto == 150 || monto == 200 || monto == 250 || monto == 300 || monto == 350 || monto == 400|| monto == 450|| monto == 500|| monto == 550|| monto == 600|| monto == 650|| monto == 700|| monto == 750|| monto == 800||monto == 850|| monto == 900 || monto == 950|| monto == 1000|| monto == 1050|| monto == 1150||monto == 1200 || monto == 1300|| monto == 1400|| monto == 1500|| monto == 1600|| monto == 1700|| monto == 1750|| monto == 2000|| monto == 3000){
    return true;
  }
  else{
    return false;
