...
<input class="form-control input-sm" type="text" SIZE=10 id="ampliacion1" onChange="validarHospedajes(this.value);"  value="0"> 
...
<input class="form-control input-sm" type="text" SIZE=10 id="ampliacion2" onChange="validarHospedajes(this.value);"  value="0"> 
