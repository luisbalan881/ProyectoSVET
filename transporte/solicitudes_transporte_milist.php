...
sec_session_start();
    if (function_exists('login_check') && login_check() == true) :
      ...
      $solicitudes = array();
        ...
        $solicitudes = solicitudes_list_user($user_id);  //solicitudes_list_user

        //$user_id =$_SESSION['user_id'];
        //include_once 'funciones_permisos.php';
        //$solicitud_permiso = permiso_salida2($user_id);
        ...
        <body >
                    ...
                    <table id="solicitudes_list_user" class="table table-bordered table-condensed table-striped ">
                      <thead >
					  <tr>
                                    <td colspan="9">
                    ...
                    $(document).ready(function() {
                      var table = $('#solicitudes_list_user').DataTable({
                        "pageLength": 50,
