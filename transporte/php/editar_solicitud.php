        ...
        <body>
            ...
            <?php } }?>
                    ...
                    <div class="tickets-container">
                      <ul class="tickets-list">
                          <li class="ticket-item">
                              <div class="row">
                                  <div class="ticket-time col-md-9 col-sm-12">
                      ...
                      <ul class="tickets-list">
                          <li class="ticket-item">
                              <div class="row">
                                  140
                                  <div class="ticket-time  col-md-9 col-sm-12 col-xs-12">
                ...
                <br>
                  ...
                  <?php if($conteo2==0){ //   if (usuarioPrivilegiado()->hasPrivilege('autorizarSolicitudTransporte')) 
