    ...
    if (function_exists('login_check') && login_check() == true) :
        if ($u->hasPrivilege('crearSolicitudTransporte') ) :
            ...
            $departamentos = departamentos();
			 $fecha_bloqueada1 = fechas_bloqueada1();
			 $fecha_bloqueada2 = fechas_bloqueada2();
			  $fecha_bloqueada3 = fechas_bloqueada3();
                      ...
                      <div class="col-xs-2 col-sm-25">
                          <div class="form-material">
                            <div class="input-group has-personalizado">
                              ...
                              <input class="js-datepicker form-control" type="text" id="soli_fecha1" name="soli_fecha1" data-date-language="es-ES"   data-provide="datepicker" data-date-format="dd-mm-yyyy" placeholder="dd-mm-yyyy"  value=" <?php  echo $date1 = date('d-m-Y', strtotime($fecha_bloqueada1['fecha']));  ?>" disabled>
                            </div>

                              <label for="soli_fecha2">Fecha1 ocupada </label>
                          </div>
                      </div>
						<div class="col-xs-2 col-sm-25">
                          <div class="form-material">
                            <div class="input-group has-personalizado">
                              <span class="input-group-addon" ><span class="fa fa-calendar-check-o"></span></span>
                              <input class="js-datepicker form-control" type="text" id="soli_fecha2" name="soli_fecha2" data-date-language="es-ES"   data-provide="datepicker" data-date-format="dd-mm-yyyy" placeholder="dd-mm-yyyy"  value=" <?php  echo $date1 = date('d-m-Y', strtotime($fecha_bloqueada2['fecha']));  ?>" disabled>
                            </div>

                              <label for="soli_fecha2">Fecha2 ocupada </label>
                          </div>
                      </div>
                          ...
                          <div class="form-material">
                            <div class="input-group has-personalizado">
                              <span class="input-group-addon" ><span class="fa fa-calendar-check-o"></span></span>
                              <input class="js-datepicker form-control" type="text" id="soli_fecha3" name="soli_fecha3" data-date-language="es-ES"   data-provide="datepicker" data-date-format="dd-mm-yyyy" placeholder="dd-mm-yyyy"  value=" <?php  echo $date1 = date('d-m-Y', strtotime($fecha_bloqueada3['fecha']));  ?>" disabled>
                            </div>

                              <label for="soli_fecha2">Fecha3 ocupada </label>
                          </div>
                      </div>
                  ...
                  <div class="form-group">
                      <div class="col-xs-2 col-sm-25">
                          <div class="form-material">
                            <div class="input-group has-personalizado">
                              <span class="input-group-addon" ><span class="fa fa-calendar-check-o"></span></span>
                              <input class="js-datepicker form-control" type="text" id="soli_fecha" name="soli_fecha" data-date-language="es-ES"   data-provide="datepicker" data-date-format="dd-mm-yyyy" placeholder="dd-mm-yyyy"  onChange="validarFecha(this.value);" required>
                            </div>
                    ...
                    <div class="">
                      <div class="table-responsive">
                        ...
                        <table class="table" width="100%" id="crud_table">
                         <thead>
                           <th width="50%" style="border:12px solid transparent" >Destino (s)</th>
                           <th width="50%" style="border:1px solid transparent" >Motivo (s)</th>
