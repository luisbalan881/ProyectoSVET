...
if (function_exists('login_check') && login_check() == true):
    ...
    ?>
        ...
        <head>
            ...
            <script src="transporte/js/mi_list.js"></script>
              ...
              <div class="row items-push">
                  <div class="col-sm-7">
                      <h1 class="page-heading">
                          CONTROL DE MIS SOLICITUDES DE TRANSPORTE.
                      </h1>
                  </div>
            ...
            <div class="block block-themed block-rounded">
              <div class=" block-header bg-muted ">
				...
				<?php if ($u->hasPrivilege('autorizarSolicitudTransporte') ) :?>
                  ...
                  <li>
                      <button type="button" data-toggle="modal" data-target="#modal-remoto-lgg" href="transporte/solicitar_transporte_manual2.php" ><i class="fa fa-plus"></i></button>
                  </li>
				  <?php endif ?>
                  <li>
                ...
                <h3 class="block-title">Control de mis Solicitudes de Vehículos.</h3>
              </div>
