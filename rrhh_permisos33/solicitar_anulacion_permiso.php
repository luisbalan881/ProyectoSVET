                ...
                <h1>Anular Solicitud</h1>
                  ...
                  <div class="form-group">
                    <div class="col-sm-12 text-center">  
                         <button id="boton_s_t" class="btn btn-sm btn-warning btn-block" onclick="add_solicitud_anular(<?php echo $id2 ?>,<?php echo $persona->persona['dep_id']?>)" ><i id="loading1" class="fa fa-refresh fa-spin" style="display:none;"></i> Si Anular </button>
                    </div>
                  </div>
