<?php
    ...
    if (function_exists('login_check') && login_check() == true) :
        if ($u->hasPrivilege('crearSolicitudTransporte') ) :
			...
			$pases = solicitudes_pases($id2);//$lista1 = $p->fetch(PDO::FETCH_ASSOC);
        ...
        <head>
            ...
            <script src="assets/js/pages/solicitud_form_validate_permiso_salidas_edit.js"></script>
          ...
          <div class="">
            ...
            <div class="block-content ">
              ...
              <form id="SolicitudForm" class="js-validation-solicitud form-horizontal form-style-10" method="POST" enctype="multipart/form-data">
                <h1>Editar <span>Modificar Solicitud de Permiso. </span></h1>
                  ...
                  <div class="form-group">
                      <div class="col-xs-2 col-sm-25">
                          <div class="form-material">
                            <div class="input-group has-personalizado">
                              ...
                              <input class="js-datepicker form-control" type="text" id="soli_fecha" name="soli_fecha" data-date-language="es-ES" data-date-days-of-week-disabled="0,7" data-provide="datepicker" data-date-format="yyyy-mm-dd" placeholder="yyyy-mm-dd"   value=" <?php echo $pases['fecha']; ?>">
					  ...
					  <div class="col-xs-2 col-sm-25">
                          <div class="form-material">
                            <div class="input-group has-personalizado">
                              ...
                              <input class="form-control"   id="soli_salida1" name="soli_salida1" value="<?php echo $pases['hora_inicio']; ?>" required>
					  ...
					  <div class="col-xs-2 col-sm-25">
                          <div class="form-material">
                            <div class="input-group has-personalizado">
                              <span class="input-group-addon" ><span class="fa fa-clock-o"></span></span>
                              <input class="form-control"    id="soli_salida2" name="soli_salida2" value="<?php echo $pases['Hora_fin']; ?>" required>
                            </div>
					  ...
					  <div class="col-xs-2 col-sm-25">
                          <div class="form-material ">
                            <div class="input-group has-personalizado">
                              <span class="input-group-addon" ><span class="fa fa-clock-o"></span></span>
                              <input class="form-control"  type="number"  id="soli_tiempo" name="soli_tiempo" min="1" max="60" value="<?php echo $pases['duracion']; ?>" required>
                            </div>
                          ...
                          <div class="form-material">
                            <div class="input-group has-personalizado">
                              ...
                              <select class="form-control" name="horas_dias" id="horas_dias"data-placeholder="Seleccione uno o mas Departamentos"  required>
                                <option value="" disabled selected hidden><?php echo $pases['tipo_tiempo']; ?></option>
                          ...
                          <div class="form-material">
                            <div class="input-group has-personalizado">
                              ...
                              <select class="form-control" name="t_completo" id="t_completo"data-placeholder="Seleccione uno" required>
                                 <option value="" disabled selected hidden><?php echo $pases['tiempo_completo']; ?></option>
                                <option value="Pase de salida"> Pase de salida</option>
                                <option value="Licencia"> Licencia</option>
								<option value="Licencia"> Permiso</option>
                    ...
                    <div class="col-xs-12">
                          ...
                          <div class="has-personalizado">
                            ...
                            <div class="input-group has-personalizado">
                              ...
                              <textarea class="form-control" id="soli_just" name="soli_just" maxlength="90" rows="1"  required > <?php echo $pases['justificacion']; ?>  </textarea>
                            </div>
                  ...
                  <div class="form-group">
                    <div class="col-xs-12">
                          ...
                          <div class="has-personalizado">
                            ...
                            <div class="input-group has-personalizado">
                              <span class="input-group-addon" ><span class="si si-pencil"></span></span>
                              <textarea class="form-control" id="soli_obs" name="soli_obs" maxlength="90" rows="1" required ><?php echo $pases['obs']; ?> </textarea>
                            </div>
                  ...
                  <div class="form-group">
                    <div class="col-sm-12 text-center">
                        <button id="boton_s_t" class="btn btn-sm btn-primary btn-block" onclick="add_solicitud_editable(<?php echo $id2 ?>,<?php echo $persona->persona['dep_id']?>)" ><i id="loading1" class="fa fa-refresh fa-spin" style="display:none;"></i> Modificar </button>
                    </div>
                  </div>
