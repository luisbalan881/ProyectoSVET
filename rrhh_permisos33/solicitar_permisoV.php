                      ...
                      <div class="col-xs-12">
                          <div class="form-material">
                              ...
                              <div class="input-group has-personalizado">
                                ...
                                <select name="gt" id="gt"  multiple="multiple" data-placeholder="Seleccionar el periodo más antiguo que debe de consumir" class="chosen-select-width col-xs-12 form-control" multiple tabindex="6" required>
                               
    <option value="Merceders"> 2019</option>  
    <option value="BMW"> 2020 </option>  
    <option value="Jaguar"> 2021 </option>  
    <option value="Lamborghini"> 2022 </option>  
    <option value="Ferrari"> 2023 </option>  
...
<div id="mostrar_mensaje"></div>
          ...
          <script>
              ...
              $('#d_solicitantes').timepicki();  //pendientes1
			  
			  
			     var dias_res2 = $('#d_solicitantes').val(); //pendientes
	...
	var $periodo=$('#gt').val();
      ...
      $.ajax({
        data: parametros,
        url: 'rrhh_permisos/php/add_solicitud_consulta.php',
        type: 'POST',
