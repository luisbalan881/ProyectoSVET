<?php
  ...
  <div class="col-xs-1 col-sm-25">
                          <div class="form-material ">
                            <div class="input-group has-personalizado">
                              <span class="input-group-addon" ><span class="fa fa-clock-o"></span></span>
                              <input class="form-control"  type="number"  id="soli_tiempo" name="soli_tiempo" min="1" max="20"   required >
                            </div>
                      ...
                      <div class="col-xs-12">
                          <div class="form-material">
                              ...
                              <div class="input-group has-personalizado">
                                ...
                                <select class="form-control" name="d_solicitantes" id="d_solicitantes"data-placeholder="Seleccione" required>
