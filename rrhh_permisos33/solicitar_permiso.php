<?php
    ...
    if (function_exists('login_check') && login_check() == true) :
        if ($u->hasPrivilege('crearSolicitudTransporte') ) :
			...
			$pendientes2=ver_status_solicitud($id);
...
//echo $dept['status'];
        ...
        <head>
            ...
            <script src="assets/js/plugins/jspdf/pdfFromHTML1.js"></script>
			 ...
			 <script src="rrhh_permisos/js/validarentradas.js"></script>
			  <script src="rrhh_permisos/js/validarentradas2.js"></script>
              ...
              <form id="SolicitudForm" class="js-validation-solicitud form-horizontal form-style-10" method="POST" enctype="multipart/form-data">
				...
				<label> <h3> DATOS DE PERIODO </h3></label>
				 ...
				 <?php
                               ...
                               /*   foreach ($pendientes2 as $list_bitacora1){
    ...
    // echo validarKilometrosFinales2();
				   ...
				   <div class="col-xs-1 col-sm-25" hidden >
				   
                          <div class="form-material ">
                            <div class="input-group has-personalizado">
                              <span class="input-group-addon" ><span class="fa fa-clock-o"></span></span>
                              <input class="form-control"  type="number"  id="soli_tiemp3" name="soli_tiemp3" value="<?php echo $pendientes2['status'] ?>" disabled  >
                            </div>
                            <label for="soli_tiemp3">Estado de solictud*</label>
                          </div>
                      </div>
				   ...
				   <div class="col-xs-1 col-sm-25">
					     ...
					     <div class="col-xs-1 col-sm-25">
                          <div class="form-material ">
                            ...
                            <label for="pendientes1">Dias pendientes al 31/12*</label>
                          </div>
                      </div> 
					  ...
					  <div class="col-xs-1 col-sm-25">
                          <div class="form-material ">
                            ...
                            <label for="dias_restantes">Dias disponibles a la fecha*</label>
                          </div>
                      </div> 
					   ...
					   <div class="col-xs-1 col-sm-25">
					    ...
					    <div class="col-xs-1 col-sm-25" hidden>
                          <div class="form-material ">
                            <div class="input-group has-personalizado">
                              <span class="input-group-addon" ><span class="fa fa-clock-o"></span></span>
                              <input class="form-control"  type="number"  id="periodo_id" name="periodo_id" value="<?php echo round($año_periodo_user['id_periodo_user']) ?>" disabled >
                            </div>
					  ...
					  <!--
					   <div class="col-xs-1 col-sm-25">
                          <div class="form-material ">
                            <div class="input-group has-personalizado">
                              <span class="input-group-addon" ><span class="fa fa-clock-o"></span></span>
                              <input class="form-control"  type="number"  id="periodo1" name="periodo1" value="<?php echo round($año_periodo_user['id_periodo_user']) ?>" disabled >
                            </div>
                            <label for="periodo1">Año*</label>
                          </div>
                      </div> -->
                      ...
                      <div class="col-xs-2 col-sm-25">
                       ...
                       <div class="col-xs-2 col-sm-25">
                          <div class="form-material">
                            <div class="input-group has-personalizado">
                              <span class="input-group-addon" ><span class="fa fa-calendar-check-o"></span></span>
                              <input class="js-datepicker form-control" type="text" id="soli_fecha2" name="soli_fecha2" data-date-language="es-ES"  data-provide="datepicker" data-date-format="dd-mm-yyyy" placeholder="dd-mm-yyyy"  required>
                            </div>
                       ...
                       <div class="col-xs-2 col-sm-25">
                          <div class="form-material">
                            <div class="input-group has-personalizado">
                              <span class="input-group-addon" ><span class="fa fa-calendar-check-o"></span></span>
                              <input class="js-datepicker form-control" type="text" id="soli_fecha3" name="soli_fecha3" data-date-language="es-ES"  data-provide="datepicker" data-date-format="dd-mm-yyyy" placeholder="dd-mm-yyyy"  required>
                            </div>
  ...
  <div class="col-xs-1 col-sm-25">
                          <div class="form-material ">
                            <div class="input-group has-personalizado">
                              <span class="input-group-addon" ><span class="fa fa-clock-o"></span></span>
                              <input class="form-control"  type="number"  id="soli_tiempo" name="soli_tiempo" min="0.50" max="20" step="0.50"  required onChange="validarDias(this.value);">
                            </div>
 ...
 <div class="form-group">
                      <div class="col-xs-12">
                          <div class="form-material">
                              ...
                              <div class="input-group has-personalizado">
                                ...
                                <select name="d_solicitantes" id="d_solicitantes"  multiple="multiple" data-placeholder="Seleccionar el periodo más antiguo que debe de consumir" class="chosen-select-width col-xs-12 form-control" multiple tabindex="6" required onChange="validarPeriodo(this.value);">
                                  <?php
                  ...
                  <div class="form-group">
                    <div class="col-sm-12 text-center">
                        <button id="boton_s_t" class="btn btn-sm btn-primary btn-block" onclick="add_solicitud1(<?php echo $id ?>,<?php echo $persona->persona['dep_id']?>)"  disabled><i id="loading1" class="fa fa-refresh fa-spin" style="display:none;"></i> Crear Solicitud</button>
                    </div>
                  </div>
		...
		//	  alert(periodo1);
		 swal("error ", " Actual mente No se puede utilizar el periodo 2023 hasta nuevo aviso" , "error");
        ...
        btnEnviar.disabled = true;
			...
			<script>   
                ...
                var validar = $('#soli_tiemp3').val(); //pendientes
				// var validar2 = $('#soli_tiempo2').val(); //pendientes
				var btnEnviar = document.getElementById('boton_s_t');
				
				var btnEnviar2 = document.getElementById('soli_tiempo');


				if (validar == 1){  
				alert("No se puede crear una nueva solicitud porque tiene pendiente de validar una solicitud anterio.  ¡Verificar en Mis Vacaciones! ");
				//swal("error ", " No se puede crear una nueva solicitud porque tiene pendiente de validar una solicitud anterio.  ¡Verificar en Mis Vacaciones! " , "error");
				
				 btnEnviar.disabled = false;
				// btnEnviar2.disabled = false;
				 myFunction();
				 location.reload();  // primer opcion
			...
			else {  alert("Instrucciones: en la siguiente ventana aparecerán los datos del periodo más antiguo o actual que aun tiene disponible días de vacaciones, llenar los datos solicitados y validarlos en Mis vacaciones");
			 btnEnviar.disabled = true;
