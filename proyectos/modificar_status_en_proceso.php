...
if (function_exists('login_check') && login_check()):
    ...
    ?>
        ...
        <head>
          ...
          <title>Modificar estado a en proceso</title>
        </head>
        <body>
          <div class="block block-themed block-transparent remove-margin-b">
            <div class="block-header bg-info">
                ...
                <h3 class="block-title">Modificara en proceso</h3>
            </div>
                    ...
                    <div class="form-group">
                        <div class="col-xs-12">
                            <div class="form-material">
                                ...
                                <label for="tipo_nombre">Nombre de la actividad*</label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-xs-12">
                            ...
                            <h3 class="block-title">El estado actual de la actividad es iniciado</h3>
                            </label>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-xs-12 text-center">
                            <button class="btn btn-sm btn-info btn-block" type="submit"><i class=""></i>Cambiar de estado a en proceso</button>
                        </div>
                    </div>
                </form>
            </div>
