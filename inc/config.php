...
$one->l_sidebar_visible_mobile     = true;    // True: Visible Sidebar (< 992px), False: Hidden Sidebar (< 992px)
...
if ($u != NULL && $u->hasPrivilege('leerAlmacen')){
    array_push($one -> main_nav,
		...
		array(
            'name'  => '<span class="sidebar-mini-hide">Manejo de hojas de Kardex</span>',
            'icon'  => 'fa fa-align-justify',
            'url'   => '?ref=_4'
        ),
        array(
...
//Menu de control de mis Solicitudes de transporte
if ($u != NULL && $u->hasPrivilege('autorizarSolicitudTransporte')){  //boloqueo_fecha_solicitar_transporte
    array_push($one -> main_nav,
        array(
            'name'  => '<span class="sidebar-mini-hide">TRANSPORTE</span>',
            'type'  => 'heading'
        ),
        array(
            'name'  => '<span class="sidebar-mini-hide">Mis Solicitudes Transporte </span>',
...
/*
// solicitudes de vehiculo por usuario

if ($u != NULL && $u->hasPrivilege('autorizarSolicitudTransporte')){  //boloqueo_fecha_solicitar_transporte
    array_push($one -> main_nav,
        array(
            'name'  => '<span class="sidebar-mini-hide">CONTROL MIS SOLICITUDES DE TRANSPORTE</span>',
            'type'  => 'heading'
        ),
        array(
            'name'  => '<span class="sidebar-mini-hide">Mis Solicitudes Transporte</span>',
...
array_push($one -> main_nav,
    array(
        'name'  => '<span class="sidebar-mini-hide">VIÁTICOS</span>',
        'type'  => 'heading'
    ),
	...
	array(
	 ...
	 array(
        'name'  => '<span class="sidebar-mini-hide">Asignación de Actividades</span>',
        'type'  => 'heading'
    ),
	 array(
        'name'  => '<span class="sidebar-mini-hide">Asignación de Actividades</span>',
   ...
   array(
	...
	array(
        'name'  => '<span class="sidebar-mini-hide">VACACIONES Y PERMISOS</span>',
        'type'  => 'heading'
    ),
   
	 array(
        'name'  => '<span class="sidebar-mini-hide">Mis Vacaciones </span>',
        'icon'  => 'fa fa-download',
        'url'   => '?ref=_92'
    ),
	
	array(
        'name'  => '<span class="sidebar-mini-hide">Mis pases de salida  </span>',
        'icon'  => 'fa fa-download',
        'url'   => '?ref=_95'
    ),
    array(
        'name'  => '<span class="sidebar-mini-hide">pases de salida  </span>',
        'icon'  => 'fa fa-download',
        'url'   => '?ref=_951'
    )
...
if ($u != NULL && $u->hasPrivilege('AsignarPermiso')){
array_push($one -> main_nav,
   /* array(
        'name'  => '<span class="sidebar-mini-hide">Vacaciones</span>',
        'type'  => 'heading'
    ),
	...
	array(
        'name'  => '<span class="sidebar-mini-hide">Mis solicitudes  </span>',
        'icon'  => 'fa fa-download',
        'url'   => '?ref=_95'
    ),
     */
   ...
   array(
        'name'  => '<span class="sidebar-mini-hide">Admin Vacaciones</span>',
        'icon'  => 'fa fa-download',
        'url'   => '?ref=_93'
    ),     
	
	 array(
        'name'  => '<span class="sidebar-mini-hide">Retorno de Vacaciones</span>',
        'icon'  => 'fa fa-download',
        'url'   => '?ref=_96'
    ),
    
		array(
        'name'  => '<span class="sidebar-mini-hide">listado de Denuncias</span>',
        'type'  => 'heading'
    ),
	 array(
        'name'  => '<span class="sidebar-mini-hide">Denuncias</span>',
        'icon'  => 'fa fa-phone-square',
        'url'   => '?ref=_54'
    )
);
...
array_push($one -> main_nav,
    array(
        'name'  => '<span class="sidebar-mini-hide">KILOMETRAJE</span>',
        'type'  => 'heading'
    ),
	...
	array(
	   ...
	   array(
        'name'  => '<span class="sidebar-mini-hide">Administración</span>',
        'icon'  => 'fa fa-car',
        'url'   => '?ref=_45'
    ),
      array(
...
if ($u != NULL && $u->hasPrivilege('autorizarSolicitudTransporte')){
    array_push($one -> main_nav,
        array(
            'name'  => '<span class="sidebar-mini-hide">CONTROL DE PROYECTOS</span>',
            'type'  => 'heading'
        ),
       
        array(
            'name'  => '<span class="sidebar-mini-hide">Proyectos</span>',
            'icon'  => 'fa fa-file-text-o',
            'url'   => '?ref=_53'
        ),
         array(
            'name'  => '<span class="sidebar-mini-hide">Actividades</span>',
            'icon'  => 'fa fa-file-text-o',
            'url'   => '?ref=_52'
        ),
...
//
 ...
 array(
        'name'  => '<span class="sidebar-mini-hide">Compras </span>',
        'type'  => 'heading'
    ),        
        
        array(
            'name'  => '<span class="sidebar-mini-hide">Solicitudes de Compra</span>',
            'icon'  => 'fa fa-file-text-o',
            'url'   => '?ref=_5000'
        )
...
// Menu de Proyectos
if ($u != NULL && $u->hasPrivilege('viaticos')){
    array_push($one -> main_nav,
        array(
            'name'  => '<span class="sidebar-mini-hide">CONTROL DE VIÁTICOS</span>',
            'type'  => 'heading'
        ),
		 array(
            'name'  => '<span class="sidebar-mini-hide">Administracion de viáticos</span>',
            'icon'  => 'fa fa-file-text-o',
            'url'   => '?ref=_77'
        ),
		array(
        'name'  => '<span class="sidebar-mini-hide">Reporte Viáticos</span>',
        'icon'  => 'fa fa-download',
        'url'   => '?ref=_78'
    )
    );
...
array_push($one -> main_nav,
	...
	array(
        'name'  => '<span class="sidebar-mini-hide">Traslado de Bienes</span>',
        'icon'  => 'fa fa-phone-square',
        'url'   => '?ref=_200'
    ),

   array(
        'name'  => '<span class="sidebar-mini-hide">Ver No. Oficios</span>',
        'icon'  => 'fa fa-phone-square',
        'url'   => '?ref=_137'
    ),    
    array(
    ...
    array(
     ...
     array(
            'name'  => '<span class="sidebar-mini-hide">Herramientas de </span>',
            'type'  => 'heading'
        ),
    
	 array(
        'name'  => '<span class="sidebar-mini-hide">Mis Asignados</span>',
        'icon'  => 'fa fa-phone-square',
        'url'   => '?ref=_544'
    ),
	   array(
        'name'  => '<span class="sidebar-mini-hide">Listado </span>',
        'icon'  => 'fa fa-phone-square',
        'url'   => '?ref=_545'
    ),
    array(
...
array_push($one -> main_nav,
    array(
        'name'  => '<span class="sidebar-mini-hide label label-danger-footer">SVET &copy MJGA;  2024 </span>',
        'type'  => ''
    )
);
