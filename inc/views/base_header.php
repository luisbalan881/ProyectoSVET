                ...
                <ul class="dropdown-menu dropdown-menu-right">
                    ...
                    <li>
                      ...
                      <!--  <script src="transporte/js/load_solicitud.js"></script>
                       <a tabindex="-1" data-toggle="modal" data-target="#modal-remoto-lgg" href="transporte/solicitar_transporte.php"  style="cursor:pointer;">
                            <i class="fa fa-car pull-right"></i>Solicitar Transporte
						...
						<a tabindex="-1" data-toggle="modal" data-target="#modal-remoto-lgg" href="viaticos/solicitar_nombramiento.php"  style="cursor:pointer;">
                            <i class="fa fa-car pull-right"></i>Crear Nombramiento
                        </a>
						
						<a tabindex="-1" data-toggle="modal" data-target="#modal-remoto-lgg" href="proyectos/crear_proyecto.php"  style="cursor:pointer;">

                             <i class="si si-speedometer pull-right"></i>Crear Proyecto
                        </a>
						
						<a tabindex="-1" data-toggle="modal" data-target="#modal-remoto-lgg" href="denuncias/crear_denuncia_anonima.php"  style="cursor:pointer;">

                             <i class="si si-speedometer pull-right"></i>Denuncia
                        </a>

						 <a tabindex="-1" data-toggle="modal" data-target="#modal-remoto-lgg" href="combustible/reg_km_ini_user.php"  style="cursor:pointer;">
                            <i class="fa fa-car pull-right"></i>Registrar Kilometros
