                ...
                <div class="block-content">
                    <form class="js-validation-factura form-horizontal push-10-t push-10" action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST">
                        ...
                        <div class="form-group">
                            <div class="col-xs-6">
                                <div class="form-material">
                                    <input class="form-control"  type="number"  id="fac_control" name="fac_control" value="<?php echo nuevo_control() ?>" required disabled>
                                    <label for="fac_control">Número de Control*</label>
                                </div>
                            </div>
                            <div class="col-xs-6">
                                <div class="form-material">
                                    <input class="form-control"  type="number"  id="fac_1h" name="fac_1h" value="<?php echo nuevo_1h() ?>" required disabled>
                        ...
                        <div class="form-group">
                            <div class="col-xs-12 text-center">
                                <button class="btn btn-sm btn-success btn-block" type="submit" onclick="activarcaja()"><i class=""></i>Crear Factura</button>
                            </div>
                        </div>
                    </form>
                </div>
