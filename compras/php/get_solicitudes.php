...
$pdo = Database::connect();
$pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
$sql = "SELECT id_nombramiento, CONCAT(vp_user.user_nm1,' ', vp_user.user_nm2,' ', vp_user.user_ap1,' ', vp_user.user_ap2) as nombre,vp_user.sueldo_total,vp_user.partida_presupuestaria,vs_nombramiento.cod_nombramiento,vs_nombramiento.objetivo,vs_nombramiento.hora_inicio,vs_nombramiento.hora_fin,vs_nombramiento.justificacion_ampliacion,vs_nombramiento.lugar, vs_nombramiento.fecha , vs_nombramiento.fecha_inicio, vs_nombramiento.fecha_fin , vs_nombramiento.actividades, vs_nombramiento.logros, vs_nombramiento.fecha_liquidacion, vs_nombramiento.objetivod, vp_deptos.dep_nm , vp_user.user_puesto, vp_user.user_nit
FROM vs_nombramiento 
join vp_user 
on vs_nombramiento.id_funcionario = vp_user.user_id 
join vp_deptos
...
$pdo = Database::connect();
$pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
$sql = "SELECT da_solicitud_compra.id_solicitud_compra, vp_deptos.dep_nm, CONCAT(vp_user.user_nm1, ' ', vp_user.user_nm2, ' ',vp_user.user_ap1,' ',vp_user.user_ap2) AS solicitante, da_solicitud_compra.fecha_creacion, da_solicitud_compra.clasificacion, da_solicitud_compra.estado_solicitud, da_solicitud_compra.observaciones, da_solicitud_compra.fecha_creacion, da_solicitud_compra.estado_solicitud, da_solicitud_compra.correlativo FROM `da_solicitud_compra` 
join vp_user
on da_solicitud_compra.id_solicitante=vp_user.user_id
join vp_deptos
on da_solicitud_compra.id_dep=vp_deptos.dep_id
where da_solicitud_compra.id_solicitud_compra =? ";
...
function get_solicitud_by_id_detalle1($id){
$pdo = Database::connect();
$pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
$sql = "SELECT  T1.id_solicitud, T1.cantidad, T1.codigo_insumo, T1.codigo_presentacion, T1.unidad_medida ,  T1.nombre, T1.caracteristicas, T1.renglon, T1.clasificacion_compra,  T1.distribucion FROM da_detalle_solicitud_compra AS T1 where T1.id_solicitud =? AND T1.distribucion=0 ORDER BY T1.id_detalle DESC ";
$p = $pdo->prepare($sql);
$p->execute(array($id));
$comision = $p->fetchAll();
Database::disconnect();
...
//get_detalle compra2
function get_solicitud_by_id_detalle2($id){
$pdo = Database::connect();
$pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
$sql = "SELECT  T1.id_solicitud, T1.cantidad, T1.codigo_insumo, T1.codigo_presentacion, T1.unidad_medida ,  T1.nombre, T1.caracteristicas, T1.renglon, T1.clasificacion_compra,  T1.distribucion FROM da_detalle_solicitud_compra AS T1 where T1.id_solicitud =? AND T1.distribucion=1 ORDER BY T1.id_detalle DESC ";
$p = $pdo->prepare($sql);
$p->execute(array($id));
$comision = $p->fetchAll();
Database::disconnect();
...
function get_solicitud_by_id_detalle3($id){
$pdo = Database::connect();
$pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
$sql = "SELECT  T1.id_solicitud, T1.cantidad, T1.codigo_insumo, T1.codigo_presentacion, T1.unidad_medida ,  T1.nombre, T1.caracteristicas, T1.renglon, T1.clasificacion_compra,  T1.distribucion FROM da_detalle_solicitud_compra AS T1 where T1.id_solicitud =? AND T1.distribucion=2 ORDER BY T1.id_detalle DESC ";
$p = $pdo->prepare($sql);
$p->execute(array($id));
$comision = $p->fetchAll();
Database::disconnect();
...
//get_detalle compra4
function get_solicitud_by_id_detalle4($id){
$pdo = Database::connect();
$pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
$sql = "SELECT  T1.id_solicitud, T1.cantidad, T1.codigo_insumo, T1.codigo_presentacion, T1.unidad_medida ,  T1.nombre, T1.caracteristicas, T1.renglon, T1.clasificacion_compra,  T1.distribucion FROM da_detalle_solicitud_compra AS T1 where T1.id_solicitud =? AND T1.distribucion=3 ORDER BY T1.id_detalle DESC ";
$p = $pdo->prepare($sql);
$p->execute(array($id));
$comision = $p->fetchAll();
Database::disconnect();
...
function get_solicitud_by_id_detalle5($id){
$pdo = Database::connect();
$pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
$sql = "SELECT  T1.id_solicitud, T1.cantidad, T1.codigo_insumo, T1.codigo_presentacion, T1.unidad_medida ,  T1.nombre, T1.caracteristicas, T1.renglon, T1.clasificacion_compra,  T1.distribucion FROM da_detalle_solicitud_compra AS T1 where T1.id_solicitud =? AND T1.distribucion=4 ORDER BY T1.id_detalle DESC ";
$p = $pdo->prepare($sql);
$p->execute(array($id));
$comision = $p->fetchAll();
Database::disconnect();
...
//get_detalle compra6
function get_solicitud_by_id_detalle6($id){
$pdo = Database::connect();
$pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
$sql = "SELECT  T1.id_solicitud, T1.cantidad, T1.codigo_insumo, T1.codigo_presentacion, T1.unidad_medida ,  T1.nombre, T1.caracteristicas, T1.renglon, T1.clasificacion_compra,  T1.distribucion FROM da_detalle_solicitud_compra AS T1 where T1.id_solicitud =? AND T1.distribucion=5 ORDER BY T1.id_detalle DESC ";
$p = $pdo->prepare($sql);
$p->execute(array($id));
$comision = $p->fetchAll();
Database::disconnect();
...
function get_solicitud_by_id_detalle7($id){
$pdo = Database::connect();
$pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
$sql = "SELECT  T1.id_solicitud, T1.cantidad, T1.codigo_insumo, T1.codigo_presentacion, T1.unidad_medida ,  T1.nombre, T1.caracteristicas, T1.renglon, T1.clasificacion_compra,  T1.distribucion FROM da_detalle_solicitud_compra AS T1 where T1.id_solicitud =? AND T1.distribucion=6 ORDER BY T1.id_detalle DESC ";
$p = $pdo->prepare($sql);
$p->execute(array($id));
$comision = $p->fetchAll();
Database::disconnect();
...
//get_detalle compra8
function get_solicitud_by_id_detalle8($id){
$pdo = Database::connect();
$pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
$sql = "SELECT  T1.id_solicitud, T1.cantidad, T1.codigo_insumo, T1.codigo_presentacion, T1.unidad_medida ,  T1.nombre, T1.caracteristicas, T1.renglon, T1.clasificacion_compra,  T1.distribucion FROM da_detalle_solicitud_compra AS T1 where T1.id_solicitud =? AND T1.distribucion=7 ORDER BY T1.id_detalle DESC ";
$p = $pdo->prepare($sql);
$p->execute(array($id));
$comision = $p->fetchAll();
Database::disconnect();
...
$pdo = Database::connect();
$pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
$sql = "SELECT * FROM `da_detalle_solicitud_compra` where id_solicitud =?";
$p = $pdo->prepare($sql);
$p->execute(array($id));
$solicitud = $p->fetch(PDO::FETCH_ASSOC);
Database::disconnect();
...
function get_comision_by_solicitud_idAnterior($id){
  $pdo = Database::connect();
  $pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
