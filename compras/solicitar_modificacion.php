<?php
    ...
    if (function_exists('login_check') && login_check() == true) :
        if ($u->hasPrivilege('crearSolicitudTransporte') ) :
            ...
            $departamentos = departamentos();
              //$solicitud1 = get_solicitud_compra($id2);// nota crear consulta para ver los datos releveantes para devolver $bitacora
        ...
        <head>
            ...
            <script src="assets/js/pages/solicitud_form_seguimiento_compra.js"></script>
          ...
          <div class="">
            ...
            <div class="block-content ">
              <form id="SolicitudForm" class="js-validation-solicitud form-horizontal form-style-10" method="POST" enctype="multipart/form-data">
                <h1>Modificar a Solicitud de compra</h1>
   ...
   <!--
	<div class="col-xs-12 col-sm-35">
                      ...
                      value="<?php echo $solicitud1['observaciones']; ?>"
   ...
   -->
                    ...
                    <div class="col-xs-12">
                          ...
                          <div class="has-personalizado">
                            <label for="soli_desc"> (Instrucciones: El texto que ingrese en este campo modificara el texto anterior en el campo de OBSERVACIONES)</label>
                            <div class="input-group has-personalizado">
                              <span class="input-group-addon" ><span class="si si-pencil"></span></span>
                              <textarea class="form-control" id="soli_desc" name="soli_desc"   rows="5" required></textarea>
                            </div>
                  ...
                  <!--      <button id="boton_s_t" class="btn btn-sm btn-warning btn-block" onclick="add_formulario_comentario(<?php echo $id ?>,<?php echo $persona->persona['dep_id']?>, <?php   echo $id2 ?>)" ><i id="loading1" class="fa fa-refresh fa-spin" style="display:none;"></i> Enviar Cometario a Solicitud</button>
                    </div>
                     <div class="col-sm-12 text-center">  -->
                        <button id="boton_s_t" class="btn btn-sm btn-success btn-block" onclick="add_formulario_modificar(<?php echo $id ?>,<?php echo $persona->persona['dep_id']?>, <?php   echo $id2 ?>)" ><i id="loading1" class="fa fa-refresh fa-spin" style="display:none;"></i> Modificar Observaciones de Solicitud</button>
                    </div>
                  </div>
