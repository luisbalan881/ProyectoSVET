          ...
          <div class="">
            ...
            <div class="block-content ">
              <form id="SolicitudForm" class="js-validation-solicitud form-horizontal form-style-10" method="POST" enctype="multipart/form-data">
                <h1>Seguimiento a Solicitud de compra</h1>
                  ...
                  <!--      <button id="boton_s_t" class="btn btn-sm btn-warning btn-block" onclick="add_formulario_comentario(<?php echo $id ?>,<?php echo $persona->persona['dep_id']?>, <?php   echo $id2 ?>)" ><i id="loading1" class="fa fa-refresh fa-spin" style="display:none;"></i> Enviar Cometario a Solicitud</button>
                     ...
                     <div class="col-sm-12 text-center">  -->
                        <button id="boton_s_t" class="btn btn-sm btn-success btn-block" onclick="add_formulario_aprobacion(<?php echo $id ?>,<?php echo $persona->persona['dep_id']?>, <?php   echo $id2 ?>)" ><i id="loading1" class="fa fa-refresh fa-spin" style="display:none;"></i> Aprobar Solicitud</button>
                    </div>
                  </div>
