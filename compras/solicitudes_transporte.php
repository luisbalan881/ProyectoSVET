...
if (function_exists('login_check') && login_check() == true):
    ...
    ?>
        ...
        <head>
            ...
            <script src="compras/js/list.js"></script>
            <script src="compras/js/ver_solicitud.js"></script>


            <script src="compras/js/notificaciones_solicitudes.js"></script>
            ...
            <div class="block block-themed block-rounded">
              <div class=" block-header bg-muted ">
				...
				<?php if ($u->hasPrivilege('autorizarSolicitudTransporte') ) :?>
                  ...
                  <li>
                      <button type="button" data-toggle="modal" data-target="#modal-remoto-lgg" href="compras/solicitar_compra.php" ><i class="fa fa-plus"></i></button>
                  </li>
				  <?php endif ?>
                  <li>
                ...
                <h3 class="block-title">Control de Solicitud de Compras</h3>
              </div>
