          ...
          <div class="">
            <div class="">
              ...
              <div class="container-fluid">
                  <ul class="block-options2" style="margin-top:20px; margin-right:9px;">
                      <li>
            ...
            <div class="block-content ">
              <form id="SolicitudForm" class="js-validation-solicitud form-horizontal form-style-10" method="POST" enctype="multipart/form-data">
				...
				<h1>Solicitar Compra <span>Intrucciones generales: en el siguiente formulario tiene como máximo de 8 Item por solicitud   </span></h1>
                    ...
                    <div class="">
                      <div class="table-responsive">
                        ...
                        <table class="table" width="100%" id="crud_table">
                         <thead>
                           <th width="12%" style="border:2px solid transparent" >Cantidad</th>
                           <th width="14%" style="border:2px solid transparent" >Distribución</th>
                           <th width="12%" style="border:2px solid transparent" >Código Insumo</th>
                            <th width="12%" style="border:2px solid transparent" >Código Present</th>
                            <th width="12%" style="border:2px solid transparent" >Unidad de Medida</th>
                            <th width="18%" style="border:2px solid transparent" >Nombre</th>
                             <th width="30%" style="border:2px solid transparent" >Caracteristicas  </th>
                             <th width="6%" style="border:2px solid transparent" >Renglon</th>
                         ...
                         <tbody>
                           <tr>
                            ...
                            <td class="" style="border:1px solid transparent">
                                ...
                                <option value="A1-001-0001"> A1-001-0001</option>
                                <option value="A2-002-0001"> A2-002-0001</option>
                                 <option value="A2-002-0002"> A2-002-0002</option>
                                 
                                  <option value="A2-002-0005"> A2-002-0005</option>
                                <option value="A3-003-0001"> A3-003-0001</option>
                             ...
                             <td class="" style="border:1px solid transparent">
                                          ...
                                          <div class='input-group has-personalizado'>
                                            ...
                                            <input  type='text' class='form-control item_codigo_insumo' id='txtm1' ></input>
                                          </div>
                             ...
                             <td class="" style="border:1px solid transparent">
                                          ...
                                          <div class='input-group has-personalizado'>
                                            ...
                                            <input  type='text' class='form-control item_codigo_presentacion' id='c2' ></input>
                                          </div>
                            ...
                            <td class="" style="border:1px solid transparent">
                             ...
                             <td class="" style="border:1px solid transparent">
                                          ...
                                          <div class='input-group has-personalizado'>
                                            ...
                                            <textarea  type='text' class='form-control item_caracteristica' id='c1'  rows="3" required></textarea>
                                          </div>
                  ...
                  <div class="form-group">
                    <div class="col-xs-12">
                          ...
                          <div class="has-personalizado">
                            <label for="soli_desc">OBSERVACIONES (Campo obligatorio)</label>
                            <div class="input-group has-personalizado">
