$(function(){
  ...
  function get_solicitudes_list(){
    var url='compras/solicitudes_compras_list.php'
    $.ajax({
        type: "POST",
        url:url,
        data:{},
    ...
    function get_vehiculos_list(){
      $.ajax({
        ...
        type: "POST",
        url: "compras/php/get_vehiculos.php",
    ...
    function get_drivers_list(){
      $.ajax({
        ...
        type: "POST",
        url: "compras/php/get_pilotos.php",
         //f de fecha y u de estado.
    ...
    function get_solicitudes_list_perfil(emp){
      var url='compras/solicitudes_listado_perfil_list.php'
      $.ajax({
          type: "POST",
          url:url,
          data:{emp:emp},
