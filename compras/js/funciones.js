  ...
  function cancelar_solicitud(comision){
    ...
    function finalizar_solicitud(comision){
      ...
      function update_solicitud(solicitud){
        ...
        var dur_en=$("#horas_dias option:selected");//clasificacion
        var especificacion = "";
        dur_en.each(function ()
      {
        ...
        $.ajax({
          ...
          data:{solicitud:solicitud,fecha:fecha,salida:salida,duracion:duracion,especificacion:especificacion,cantidad:cantidad,desc:desc,clasificacion:clasificacion},
           //f de fecha y solicitud de estado.
 ...
 $('#add').click(function(){
  ...
  var html_code = "<tr id='row"+count+"'>";
   ...
   html_code += "<td style='border:1px solid transparent'><div class='input-group has-personalizado'><span class='' ><span class=''></span></span><input type='number' class='form-control item_cantidad' id='num1"+count+"' name='item_cantidad[]' required></input></div></div></td>";


 html_code += "<td style='border:1px solid transparent'><div class='input-group has-personalizado'><span class='' ><span class=''></span></span><select class='form-control item_destino' id='txtd"+count+"' name='item_destino[]' required >  <option value='A1-001-0001'> A1-001-0001</option>   <option value='A2-002-0001'> A2-002-0001</option> <option value='A2-002-0002'> A2-002-0002</option>  <option value='A2-002-0005'> A2-002-0005</option>  <option value='A3-003-0001'> A3-003-0001</option> <option value='A5-005-0001'> A5-005-0001</option> <option value='A5-005-0002'> A5-005-0002</option> </select> </div></div></td>";

   /* html_code += "<td style='border:1px solid transparent'><div class='input-group has-personalizado'><span class='input-group-addon' ><span class='fa fa-map-marker'></span></span><input type='' class='form-control item_destino' id='txtd"+count+"' name='item_destino[]' required></input></div></div></td>";*/

    html_code += "<td style='border:1px solid transparent'><div class='input-group has-personalizado'><span class='' ><span class=''></span></span><input type='text' class='form-control item_codigo_insumo' id='txtm1"+count+"' name='item_codigo_insumo[]' ></input></div></div></td>";

    html_code += "<td style='border:1px solid transparent'><div class='input-group has-personalizado'><span class='' ><span class=''></span></span><input type='text' class='form-control item_codigo_presentacion' id='c2"+count+"' name='item_codigo_presentacion[]' ></input></div></div></td>";

    html_code += "<td style='border:1px solid transparent'><div class='input-group has-personalizado'><span class='' ><span class=''></span></span><input type='text' class='form-control item_medida' id='m1"+count+"' name='item_medida[]' required></input></div></div></td>";

    html_code += "<td style='border:1px solid transparent'><div class='input-group has-personalizado'><span class='' ><span class=''></span></span><input type='text' class='form-control item_nombre' id='n1"+count+"' name='item_nombre[]' required></input></div></div></td>";

    html_code += "<td style='border:1px solid transparent'><div class='input-group has-personalizado'><span class='' ><span class=''></span></span><textarea  type='text' class='form-control item_caracteristica' id='c1"+count+"' name='item_caracteristica[]'  rows='3' required></textarea></div></div></td>";

    html_code += "<td style='border:1px solid transparent'><div class='input-group has-personalizado'><span class='' ><span class=''></span></span><input type='text' class='form-control item_renglon' id='r1"+count+"' name='item_renglon[]' required></input></div></div></td>";

     //html_code += "<td style='border:1px solid transparent'><div class='input-group has-personalizado'><span class='input-group-addon' ><span class='fa fa-edit'></span></span><input type='text' class='form-control item_medida' id='m1"+count+"' name='item_medida[]' required></input></div></div></td>";
